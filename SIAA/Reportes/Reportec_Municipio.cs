...
{
    public class Reportec_Municipio
    {
        #region Declaration
        ...
        #endregion
        public c_MunicipioContext db = new c_MunicipioContext();
        public List<c_Municipio> munic = new List<c_Municipio>();
...

        {
            ...
            HttpContext.Current.Response.AddHeader("content-disposition", "attachment; filename=\"ReporteMunicipio.pdf" + "\"");
        ...
        private void ReportHeader()
        {
            ...
            paragraph.Add("Listado de Municipios");
            ...
            float[] anchoColumnasencart = { 100f, 250, 250f };
            ...
            _fontStyle = FontFactory.GetFont("Tahoma", 8f, COLORDEFUENTEREPORTE);
            _PdfPCell = new PdfPCell(new Phrase("Estado", _fontStyleEncabezado));
            _PdfPCell.Border = 0;
            _PdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            _PdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _PdfPCell.BackgroundColor = COLORDEREPORTE;
        ...
        private void ReportBody()
        {
            ...
            foreach (c_Municipio b in munic)
            {
                ...
                float[] anchoColumnasBancos = { 100f,250f, 250f };
                ...
                PdfPCell _PdfPCell1 = new PdfPCell(new Phrase(b.C_Municipio.ToString(), _fontStylecliente));
                _PdfPCell1.Border = 0;
                ...
                PdfPCell _PdfPCell4 = new PdfPCell(new Phrase(b.C_Estado, _fontStylecliente));
                _PdfPCell4.Border = 0;
