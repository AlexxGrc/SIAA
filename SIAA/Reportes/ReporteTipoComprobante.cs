...
namespace SIAAPI.Reportes.Crystal
{
    public class ReporteTipoComprobante
    {
        #region Declaration
        ...
        #endregion
        public c_TipoComprobante db = new c_TipoComprobante();
        public List<c_TipoComprobante> tcomprobante = new List<c_TipoComprobante>();
...

        {
            ...
            HttpContext.Current.Response.AddHeader("content-disposition", "attachment; filename=\"ReporteTipoComprobante.pdf" + "\"");
        ...
        private void ReportHeader()
        {
            ...
            paragraph.Add("Catalogo de Tipo Comprobante");
            ...
            _PdfPCell = new PdfPCell(new Phrase("ID Tipo Comprobante", _fontStyleEncabezado));
            _PdfPCell.Border = 0;
            ...
            //_fontStyle = FontFactory.GetFont("Tahoma", 8f, COLORDEFUENTEREPORTE);
            _PdfPCell = new PdfPCell(new Phrase("Clave Tipo Comprobante", _fontStyleEncabezado));
            _PdfPCell.Border = 0;
            _PdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            _PdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _PdfPCell.BackgroundColor = COLORDEREPORTE;
            ...
            //_fontStyle = FontFactory.GetFont("Tahoma", 8f, COLORDEFUENTEREPORTE);
            _PdfPCell = new PdfPCell(new Phrase("Valor Maximo", _fontStyleEncabezado));
            _PdfPCell.Border = 0;
            _PdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            _PdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _PdfPCell.BackgroundColor = COLORDEREPORTE;
        ...
        private void ReportBody()
        {
            ...
            foreach (c_TipoComprobante i in tcomprobante)
            {
                ...
                float[] anchoColumnasTipoComprobante = { 150f, 150f, 150f, 150f };

                // 50 para id 3000 para el nombre 100 para el telefono y 150 para el vendedor


                PdfPTable tablaTipoComprobante = new PdfPTable(anchoColumnasTipoComprobante);
                //tablaProductosPrincipal.DefaultCell.Border = Rectangle.NO_BORDER;
                tablaTipoComprobante.SetTotalWidth(anchoColumnasTipoComprobante);
                tablaTipoComprobante.SpacingBefore = 3;
                tablaTipoComprobante.HorizontalAlignment = Element.ALIGN_LEFT;
                tablaTipoComprobante.LockedWidth = true;
                ...
                PdfPCell _PdfPCell1 = new PdfPCell(new Phrase(i.IDTipoComprobante.ToString(), _fontStylecliente));
                _PdfPCell1.Border = 0;
                ...
                tablaTipoComprobante.AddCell(_PdfPCell1);

                PdfPCell _PdfPCell2 = new PdfPCell(new Phrase(i.ClaveTipoComprobante, _fontStylecliente));
                _PdfPCell2.Border = 0;
                ...
                tablaTipoComprobante.AddCell(_PdfPCell2);

                PdfPCell _PdfPCell3 = new PdfPCell(new Phrase(i.Descripcion, _fontStylecliente));
                _PdfPCell3.Border = 0;
                ...
                tablaTipoComprobante.AddCell(_PdfPCell3);

                PdfPCell _PdfPCell4 = new PdfPCell(new Phrase(i.ValorMaximo, _fontStylecliente));
                _PdfPCell4.Border = 0;
                ...
                tablaTipoComprobante.AddCell(_PdfPCell4);


                _documento.Add(tablaTipoComprobante);
