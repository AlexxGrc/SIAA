...
namespace SIAAPI.Reportes
{
    public class ReporteChoferes
    {
        ...
        #endregion
        public ChoferesContext db = new ChoferesContext();
...

        {
            ...
            HttpContext.Current.Response.AddHeader("content-disposition", "attachment; filename=\"ReporteChoferes.pdf" + "\"");
        ...
        private void ReportHeader()
        {
            ...
            p1.Leading = 20;
            p1.Add(new Phrase("Catalogo de Choferes", new Font(Font.FontFamily.HELVETICA, 20, Font.BOLD)));
            p1.SpacingAfter = 40;
            _documento.Add(p1);
            ...
            float[] anchoColumnasencart = { 150f, 450f };
            ...
            //_fontStyle = FontFactory.GetFont("Tahoma", 8f, COLORDEFUENTEREPORTE);
            _PdfPCell = new PdfPCell(new Phrase("Activo", _fontStyleEncabezado));
            _PdfPCell.Border = 0;
            _PdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            _PdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _PdfPCell.BackgroundColor = COLORDEREPORTE;
        ...
        private void ReportBody()
        {
            ...
            foreach (Chofer b in choferes)
            {
                ...
                float[] anchoColumnasBancos = { 150f, 450f };

                // 50 para id 3000 para el nombre 100 para el telefono y 150 para el vendedor


                PdfPTable tablaChofer = new PdfPTable(anchoColumnasBancos);
                //tablaProductosPrincipal.DefaultCell.Border = Rectangle.NO_BORDER;
                tablaChofer.SpacingBefore = 3;
                tablaChofer.HorizontalAlignment = Element.ALIGN_LEFT;
                tablaChofer.LockedWidth = true;
                tablaChofer.SetTotalWidth(anchoColumnasBancos);
                ...
                PdfPCell _PdfPCell1 = new PdfPCell(new Phrase(b.Nombre, _fontStylecliente));
                _PdfPCell1.Border = 0;
                ...
                tablaChofer.AddCell(_PdfPCell1);

                PdfPCell _PdfPCell4 = new PdfPCell(new Phrase(b.Activo.ToString(), _fontStylecliente));
                _PdfPCell4.Border = 0;
                ...
                tablaChofer.AddCell(_PdfPCell4);

                _documento.Add(tablaChofer);
