...
namespace SIAAPI.Reportes
{
    public class ReporteporCliente
    {
        ...
        public byte[] PrepareReport(DateTime _fechaini, DateTime _fechafin, int _idCliente, string _nota)
        {
            fechaini = _fechaini;
            fechafin = _fechafin;
            ...
            HttpContext.Current.Response.AddHeader("content-disposition", "attachment; filename=\"ListadoGeneralCliente.pdf" + "\"");
        ...
        private void ReportHeader()
        {
            ...
            _PdfPCell = new PdfPCell(new Phrase("Reporte General de Cliente", _fontStyle));
    ...
    public class ITextEventsRepLFact : PdfPageEventHelper
    {
    ...
    public class fechasReporteFact
    {
