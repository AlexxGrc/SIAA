...
{
    public class ReporteMetodoDePago
    {
        #region Declaration
        ...
        #endregion
        public c_MetodoPagoContext db = new c_MetodoPagoContext();
        public List<c_MetodoPago> metodosdepago = new List<c_MetodoPago>();
...

        {
            ...
            HttpContext.Current.Response.AddHeader("content-disposition", "attachment; filename=\"ReporteMetodosDePago.pdf" + "\"");
        ...
        private void ReportHeader()
        {
            ...
            p1.Leading = 20;
            p1.Add(new Phrase("Catalogo de Metodos de Pago", new Font(Font.FontFamily.HELVETICA, 20, Font.BOLD)));
            p1.SpacingAfter = 40;
            _documento.Add(p1);
        ...
        private void ReportBody()
        {
            ...
            foreach (c_MetodoPago b in metodosdepago)
            {
                ...
                float[] anchoColumnasMetodos = { 100f, 500f };

                // 50 para id 3000 para el nombre 100 para el telefono y 150 para el vendedor


                PdfPTable tablametodos = new PdfPTable(anchoColumnasMetodos);
                //tablaProductosPrincipal.DefaultCell.Border = Rectangle.NO_BORDER;
                tablametodos.SpacingBefore = 3;
                tablametodos.HorizontalAlignment = Element.ALIGN_LEFT;
                tablametodos.LockedWidth = true;
                tablametodos.SetTotalWidth(anchoColumnasMetodos);
                ...
                PdfPCell _PdfPCell1 = new PdfPCell(new Phrase(b.ClaveMetodoPago, _fontStylecliente));
                _PdfPCell1.Border = 0;
                ...
                tablametodos.AddCell(_PdfPCell1);

                PdfPCell _PdfPCell4 = new PdfPCell(new Phrase(b.Descripcion.ToString(), _fontStylecliente));
                _PdfPCell4.Border = 0;
                ...
                tablametodos.AddCell(_PdfPCell4);

                _documento.Add(tablametodos);
