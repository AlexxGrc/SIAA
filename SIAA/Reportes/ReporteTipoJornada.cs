...
{
    public class ReporteTipoJornada
    {
        #region Declaration
        ...
        #endregion
        public c_TipoJornada  db = new c_TipoJornada();
        public List<c_TipoJornada> Jornada = new List<c_TipoJornada>();
...

        {
            ...
            HttpContext.Current.Response.AddHeader("content-disposition", "attachment; filename=\"ReporteTipoJornada.pdf" + "\"");
        ...
        private void ReportHeader()
        {
            ...
            paragraph.Add("Catalogo de Jornadas");
        ...
        private void ReportBody()
        {
            ...
            foreach (c_TipoJornada i in Jornada)
            {
                ...
                float[] anchoColumnasJornada = { 100f, 500f};

                // 50 para id 3000 para el nombre 100 para el telefono y 150 para el vendedor


                PdfPTable tablaJornada = new PdfPTable(anchoColumnasJornada);
                //tablaProductosPrincipal.DefaultCell.Border = Rectangle.NO_BORDER;
                tablaJornada.SetTotalWidth(anchoColumnasJornada);
                tablaJornada.SpacingBefore = 3;
                tablaJornada.HorizontalAlignment = Element.ALIGN_LEFT;
                tablaJornada.LockedWidth = true;
                ...
                PdfPCell _PdfPCell1 = new PdfPCell(new Phrase(i.ClaveTipoComprobante, _fontStylecliente));
                _PdfPCell1.Border = 0;
                ...
                tablaJornada.AddCell(_PdfPCell1);
                ...
                tablaJornada.AddCell(_PdfPCell2);


                _documento.Add(tablaJornada);
