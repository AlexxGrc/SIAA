...
namespace Reportes
{
    public class InventarioReporte
    {
        ...
        List<InventarioR> _inventario = new List<InventarioR>();
        int _totalColumn = 5;
        ...
        public byte[] PrepareReport(List<InventarioR> inventario)
        {
            ...
            _documento.Open();
            _pdfTable.SetWidths(new float[] { 50f, 100f, 50f, 50f, 50f});
            this.ReportHeader();
            this.ReportBody();
        ...
        private void ReportHeader()
        {
            ...
            // string imagepath = "C:\\Users\\VANE-PC\\Desktop\\Classlabel\\SIAAPI\\SIAAPI"; ///// esto no va asi        es provicional la ruta porque por método no la puedo agregar en la celda}
            ...
            _pdfTable.AddCell(imageCell);


            
            _fontStyle = FontFactory.GetFont("Tahoma", 15f, 1);
            _PdfPCell = new PdfPCell(new Phrase("Inventario de Artículos", _fontStyle));
            _PdfPCell.Colspan = _totalColumn;
            ...
            _PdfPCell = new PdfPCell(new Phrase("Almacen: " + this.almacen, _fontStyle)); // aqui te pongo la descripcion del almacen
            _PdfPCell.Colspan = _totalColumn;
            ...
            _fontStyle = FontFactory.GetFont("Tahoma", 12f, 1);
            _PdfPCell = new PdfPCell(new Phrase("Tipo de Artículo: " + this.tipoarticulo, _fontStyle)); //aqui te puse las descripciones
            _PdfPCell.Colspan = _totalColumn;
            _PdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            _PdfPCell.Border = 0;
            _PdfPCell.BackgroundColor = BaseColor.WHITE;
            ...
            _PdfPCell = new PdfPCell(new Phrase("Cref", _fontStyle));
            _PdfPCell.Border = 0;
            _PdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
            ...
            _fontStyle = FontFactory.GetFont("Tahoma", 11f, 1);
            _PdfPCell = new PdfPCell(new Phrase("Artículo", _fontStyle));
            _PdfPCell.Border = 0;
            _PdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
            _PdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _PdfPCell.BackgroundColor = BaseColor.GRAY;
            ...
            _fontStyle = FontFactory.GetFont("Tahoma", 11f, 1);
            _PdfPCell = new PdfPCell(new Phrase("Costo", _fontStyle));
            _PdfPCell.Border = 0;
            _PdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
            _PdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _PdfPCell.BackgroundColor = BaseColor.GRAY;
        ...
        private void ReportBody()
        {
            ...
            foreach (InventarioR inventario in _inventario)
            {

                _PdfPCell = new PdfPCell(new Phrase(inventario.CRef, _fontStyle));
                _PdfPCell.Border = 0;
                _PdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
                _PdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
                _PdfPCell.BackgroundColor = BaseColor.WHITE;
                _pdfTable.AddCell(_PdfPCell);
                // .Substring(1, 3)
               // _PdfPCell = new PdfPCell(new Phrase(inventario.Articulo.Substring(0, inventario.Articulo.Length > 35 ? 35 : inventario.Articulo.Length), _fontStyle));
                _PdfPCell = new PdfPCell(new Phrase(inventario.Articulo, _fontStyle));
                _PdfPCell.Border = 0;
                _PdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
                _PdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
                _PdfPCell.BackgroundColor = BaseColor.WHITE;
                ...
                _PdfPCell = new PdfPCell(new Phrase(inventario.Cantidad.ToString(), _fontStyle));
                _PdfPCell.Border = 0;
                _PdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
                _PdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
                _PdfPCell.BackgroundColor = BaseColor.WHITE;
                ...
                _PdfPCell = new PdfPCell(new Phrase(inventario.Precio.ToString(), _fontStyle));
                _PdfPCell.Border = 0;
                _PdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
                _PdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
                _PdfPCell.BackgroundColor = BaseColor.WHITE;
                ...
                _PdfPCell = new PdfPCell(new Phrase(inventario.Costo.ToString(), _fontStyle));
                _PdfPCell.Border = 0;
                _PdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
                _PdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
                _PdfPCell.BackgroundColor = BaseColor.WHITE;
