...
namespace SIAAPI.Reportes
{
    public class ReporteContenedor
    {
        ...
        #endregion
        public c_ContenedorContext db = new c_ContenedorContext();
        public List<c_Contenedor> Conte = new List<c_Contenedor>();
...

        {
            ...
            HttpContext.Current.Response.AddHeader("content-disposition", "attachment; filename=\"ReporteContenedor.pdf" + "\"");
        ...
        private void ReportHeader()
        {
            ...
            paragraph.Add("Catalogo de Contenedor");
            ...
            float[] anchoColumnasencart = { 100f, 100f, 200f, 100f,100f };
            ...
            //_fontStyle = FontFactory.GetFont("Tahoma", 8f, COLORDEFUENTEREPORTE);
            _PdfPCell = new PdfPCell(new Phrase("Código Postal", _fontStyleEncabezado));
            _PdfPCell.Border = 0;
            _PdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            _PdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _PdfPCell.BackgroundColor = COLORDEREPORTE;
            ...
            //_fontStyle = FontFactory.GetFont("Tahoma", 8f, COLORDEFUENTEREPORTE);
            _PdfPCell = new PdfPCell(new Phrase("Norma de Asentamiento", _fontStyleEncabezado));
            _PdfPCell.Border = 0;
            _PdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            _PdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _PdfPCell.BackgroundColor = COLORDEREPORTE;
        ...
        private void ReportBody()
        {
            ...
            foreach (c_Contenedor b in Conte)
            {
                ...
                float[] anchoColumnasBancos = { 100f, 100f, 200f, 100f, 100f };
                ...
                PdfPCell _PdfPCell1 = new PdfPCell(new Phrase(b.C_Colonia, _fontStylecliente));
                _PdfPCell1.Border = 0;
                ...
                PdfPCell _PdfPCell4 = new PdfPCell(new Phrase(b.C_CodigoPostal.ToString(), _fontStylecliente));
                _PdfPCell4.Border = 0;
                ...
                PdfPCell _PdfPCell3 = new PdfPCell(new Phrase(b.NomAsentamiento, _fontStylecliente));
                _PdfPCell1.Border = 0;
