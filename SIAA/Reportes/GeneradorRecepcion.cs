...
namespace SIAAPI.Reportes
{
    ...
    public class ProductoRecepcion
    {
    ...
    public class ImpuestoRecepcion
    {
    ...
    public class RetencionRecepcion
    {
        public string impuesto;
        public float importe;
    }
    ...
    public class DocumentoRecepcion
    {
        ...
        public List<ProductoRecepcion> productos = new List<ProductoRecepcion>();
        public List<ImpuestoRecepcion> impuestos = new List<ImpuestoRecepcion>();
        public List<RetencionRecepcion> retenciones = new List<RetencionRecepcion>();
    ...
    public class CreaRecepcionnPDF
    {
        ...
        public DocumentoRecepcion _templatePDF; //Objeto que contendra la información del documento pdf
        XmlDocument xDoc; // Objeto para abrir el archivo xml

        public CreaRecepcionnPDF(System.Drawing.Image logo, DocumentoRecepcion EncRecepcion)
        {
            _templatePDF = EncRecepcion;
            ObtenerLetras();
        ...
        private void AgregaPropiedadesDocumento()
        {
            ...
            _documento.AddKeywords("RECEPCIÓN");
            _documento.AddSubject("Recepción");
            _documento.AddTitle("RECEPCIÓN");
        ...
        private void AgregarDatosProductos()
        {
           ...
           celda2.BackgroundColor = colordefinido;
            ...
            foreach (ProductoRecepcion p in _templatePDF.productos)
            {
        ...
        private void AgregarTotales()
        {
            ...
            foreach (ImpuestoRecepcion i in _templatePDF.impuestos)
            {
            ...
            foreach (RetencionRecepcion i in _templatePDF.retenciones)
            {
        ...
        private void ObtenerLetras()
        {
            ...
            NumaletRe numaLet = new NumaletRe();
    ...
    public class ITextEventsRec : PdfPageEventHelper
    {
        ...
        public override void OnEndPage(iTextSharp.text.pdf.PdfWriter writer, iTextSharp.text.Document document)
        {
...

            {
                ...
                tabla.AddCell(new Phrase("Este documento es una Recepción ", new Font(Font.FontFamily.HELVETICA, 10)));
    ...
    public sealed class NumaletRe
    {
        ...
        public NumaletRe(Boolean ConvertirDecimales, String MascaraSalidaDecimal, String SeparadorDecimalSalida, Boolean LetraCapital)
        {
