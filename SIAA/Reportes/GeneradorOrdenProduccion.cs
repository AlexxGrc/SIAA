...
namespace SIAAPI.Reportes
{
    ...
    public class CreaOrdenProduccionPDF
    {
       OrdenProduccion orden = new OrdenProduccion();
        ...
        public int etiquetaxr =0;
        public string nombreDocumento = string.Empty;

        public CreaOrdenProduccionPDF(System.Drawing.Image logo,int id)
        {
            ...
            _writer.PageEvent = new ITextEventsOrdenProduccion(); // invoca la clase que esta mas abajo correspondiente al pie de pagina
        ...
        private void AgregarDatosGenerales(int id)
        {
            ...
            PdfPCell celda00 = new PdfPCell(new Phrase("DATOS GENERALES", new Font(Font.FontFamily.HELVETICA, 7, Font.BOLD)));
            ...
            PdfPCell celda0 = new PdfPCell(new Phrase("Pedido", new Font(Font.FontFamily.HELVETICA, 7, Font.BOLD, colorencabezadodefinido)));
            PdfPCell celda1 = new PdfPCell(new Phrase(orden.IDPedido.ToString(), new Font(Font.FontFamily.HELVETICA, 8)));
            PdfPCell celda2 = new PdfPCell(new Phrase("Clave", new Font(Font.FontFamily.HELVETICA, 7, Font.BOLD, colorencabezadodefinido)));
            ...
            PdfPCell celda4 = new PdfPCell(new Phrase("Fecha Entrega", new Font(Font.FontFamily.HELVETICA, 7, Font.BOLD, colorencabezadodefinido)));
            PdfPCell celda5 = new PdfPCell(new Phrase(orden.FechaCompromiso.ToShortDateString(), new Font(Font.FontFamily.HELVETICA, 7)));
            PdfPCell celda6 = new PdfPCell(new Phrase("Cliente", new Font(Font.FontFamily.HELVETICA, 7, Font.BOLD, colorencabezadodefinido)));
            if ( cliente.Mayorista)
            {
                celda6 = new PdfPCell(new Phrase("Distibuidor", new Font(Font.FontFamily.HELVETICA, 7, Font.BOLD, colorencabezadodefinido)));
            }
            PdfPCell celda7 = new PdfPCell(new Phrase(cliente.Nombre, new Font(Font.FontFamily.HELVETICA, 8)));


            decimal cantidadOrden = Math.Round(orden.Cantidad,2);

            PdfPCell celda8 = new PdfPCell(new Phrase("Cantidad", new Font(Font.FontFamily.HELVETICA, 8, Font.BOLD, colorencabezadodefinido)));
            PdfPCell celda9 = new PdfPCell(new Phrase(cantidadOrden.ToString() +" "+articulo.c_ClaveUnidad.Nombre, new Font(Font.FontFamily.HELVETICA, 15)));
            PdfPCell celda10 = new PdfPCell(new Phrase("Vendedor: ", new Font(Font.FontFamily.HELVETICA, 7, Font.BOLD, colorencabezadodefinido)));
            PdfPCell celda11 = new PdfPCell(new Phrase(vendedor.Nombre, new Font(Font.FontFamily.HELVETICA, 7)));
            PdfPCell celda12 = new PdfPCell(new Phrase("Fact. Exacta", new Font(Font.FontFamily.HELVETICA, 7, Font.BOLD, colorencabezadodefinido)));
            String factuexacta = "No";
            if (cliente.FacturacionExacta)
            {
                 factuexacta = "Si";
            }
            PdfPCell celda13 = new PdfPCell(new Phrase(factuexacta, new Font(Font.FontFamily.HELVETICA, 7)));
            ...
            PdfPCell celda15 = new PdfPCell(new Phrase(certificado, new Font(Font.FontFamily.HELVETICA, 7)));
        ...
        private void AgregarEspecificacionesTecnicas(int id)
        {
            ...
            tablaProductosTitulos.DefaultCell.HorizontalAlignment = Element.ALIGN_LEFT;
            tablaProductosTitulos.LockedWidth = true;
            PdfPCell celda00 = new PdfPCell(new Phrase("ESPECIFICACIONES TÉCNICAS", new Font(Font.FontFamily.HELVETICA, 7, Font.BOLD, colorencabezadodefinido)));
            celda00.BackgroundColor = colordefinido;
            celda00.HorizontalAlignment = Element.ALIGN_CENTER;
            tablaProductosTitulos.AddCell(celda00);
            _documento.Add(tablaProductosTitulos);
            ...
            p3.Leading = 10;
            p3.Add(new Phrase("\n" + orden.Descripcion, new Font(Font.FontFamily.HELVETICA, 12)));
            p3.SpacingAfter = 1;
            _documento.Add(p3);
            ...
            for (int i = 0; i < arraydatos.Length; i++)
            {
                ...
                if (acc == "AL PASO")
                {
                    ...
                    Alpaso = int.Parse( valor);
                }

              

                if (acc == "ETIQUETAXR" || acc == "ETIQ X ROLLO")
                {
                    especificacion.Cantidadxrollo = int.Parse(valor);
                    etiquetaxr= int.Parse(valor);
                }
                PdfPCell celdaprenc=new PdfPCell();
                PdfPCell celdavalor=new PdfPCell();
                if (acc !="OBSERVACION" && acc != "Observacion")
                {
                     celdaprenc = new PdfPCell(new Phrase(acc, new Font(Font.FontFamily.HELVETICA, 8, Font.BOLD, colorencabezadodefinido)));
                     celdavalor = new PdfPCell(new Phrase(valor, new Font(Font.FontFamily.HELVETICA, 8, Font.BOLD)));
            ...
            if (orden.Arrastre)
            {
                arrastre = "LLEVA ARRASTRE";
            }
            PdfPCell celdavalor2 = new PdfPCell(new Phrase(orden.Indicaciones + "\n"+ arrastre, new Font(Font.FontFamily.HELVETICA, 6, Font.BOLD)));
        ...
        private void AgregarDatosArticulos(int id)
        {
            try
            {
                ...
                if (articulosproduccion.Count > 0)
                {
                    ...
                    try
                    {
                        ...
                        if (etiquetaxr > 0)
                        {
                            ...
                            if (articulo.c_ClaveUnidad.ClaveUnidad == "XRO")
                            {
                                Rollos = orden.Cantidad;
                            
                            }
                           
                            else
                            {
                                Rollos = ((orden.Cantidad * 1000) / etiquetaxr);
                            }
                            ...
                            if (especificacion.IDSuaje!=0)
                            {
                                Vueltas = ((etiquetaxr / Alpaso) * (especificacion.largoproductomm + especificacion.gapavance)) / 254;

                            }
                            else
                            {
                                Vueltas = ((especificacion.largoproductomm + especificacion.gapavance) * etiquetaxr)/ 254;
                        ...
                        {
                            //Vueltas = ((especificacion.Cantidadxrollo / Alpaso) * (especificacion.largoproductomm + especificacion.gapavance)) / 254;
                            if (especificacion.IDSuaje != 0)
                            {
                                Vueltas = ((especificacion.Cantidadxrollo / Alpaso) * (especificacion.largoproductomm + especificacion.gapavance)) / 254;
                ...
                PdfPCell celdatitins = new PdfPCell(new Phrase("Cintas: ", new Font(Font.FontFamily.HELVETICA, 8, Font.BOLD, new BaseColor(System.Drawing.Color.Brown))));
                ...
                Proceso embobinado = dbp.Procesos.Find(4); /// 
                Paragraph embobinadotitulo = new Paragraph();

                List<VArticulosProduccion> articulosproduccionembo = new ArticulosProduccionContext().Database.SqlQuery<VArticulosProduccion>("select AP.Existe,Ap.Cantidad as Cantidad, A.Cref as Cref,AP.IDArtProd,A.Descripcion as Articulo,TA.Descripcion as TipoArticulo,C.Presentacion as Caracteristica,P.NombreProceso as Proceso,AP.IDOrden,AP.Cantidad,CU.Nombre as Unidad,AP.Indicaciones,AP.CostoPlaneado,AP.CostoReal from ArticuloProduccion as AP inner join Articulo as A on A.IDArticulo=AP.IDArticulo inner join TipoArticulo as TA on A.IDTipoArticulo=TA.IDTipoArticulo inner join Caracteristica as C on C.ID=AP.IDCaracteristica inner join Proceso as P on P.IDProceso=AP.IDProceso inner join c_ClaveUnidad as CU on CU.IDClaveUnidad=AP.IDClaveUnidad where AP.IDOrden=" + id + " and AP.IDProceso=" + embobinado.IDProceso + " and TA.Descripcion='Maquina'").ToList();
                if (articulosproduccion.Count > 0)
                {
                    float[] anchoColumnasTablaDatpe = { 100f, 100f, 100f, 50f, 50f, 50f, 50f, 50f };
                    PdfPTable tablaDatosPre = new PdfPTable(anchoColumnasTablaDatpe);
                    tablaDatosPre.DefaultCell.Border = Rectangle.NO_BORDER;
                    tablaDatosPre.SetTotalWidth(anchoColumnasTablaDatpe);
                    tablaDatosPre.SpacingBefore = 5;
                    tablaDatosPre.HorizontalAlignment = Element.ALIGN_LEFT;
                    tablaDatosPre.LockedWidth = true;
                    PdfPCell celdamaquinapre = new PdfPCell(new Phrase("Maquina Embobinado: ", new Font(Font.FontFamily.HELVETICA, 8)));
                    celdamaquinapre.Border = 1;
                    celdamaquinapre.HorizontalAlignment = Element.ALIGN_LEFT;
                    celdamaquinapre.BackgroundColor = CMYKColor.GRAY;
                    tablaDatosPre.AddCell(celdamaquinapre);
                    PdfPCell celdamaquinapre2 = new PdfPCell(new Phrase(articulosproduccionembo.FirstOrDefault().Articulo, new Font(Font.FontFamily.HELVETICA, 8)));
                    celdamaquinapre2.Border = 1;
                    celdamaquinapre2.HorizontalAlignment = Element.ALIGN_LEFT;
                    tablaDatosPre.AddCell(celdamaquinapre2);
                    ...
                    try
                    {
                        ...
                        Progrenmetros = ((etiquetaxr / Alpaso) * (especificacion.largoproductomm + especificacion.gapavance)) / 1000;
                        if (etiquetaxr > 0)
                        {
                            //Vueltas = ((etiquetaxr / Alpaso) * (especificacion.largoproductomm + especificacion.gapavance)) / 254;
                            if (especificacion.IDSuaje != 0)
                        ...
                        PdfPCell PROGMAQ = new PdfPCell(new Phrase("Vueltas: ", new Font(Font.FontFamily.HELVETICA, 8)));
                        PROGMAQ.Border = 1;
                        ...
                        PdfPCell PROGMAQ3 = new PdfPCell(new Phrase("Rollos", new Font(Font.FontFamily.HELVETICA, 8)));
                        PROGMAQ3.Border = 1;
                        PROGMAQ3.HorizontalAlignment = Element.ALIGN_LEFT;
                        PROGMAQ3.BackgroundColor = CMYKColor.GRAY;
                        tablaDatosPre.AddCell(PROGMAQ3);
                        PdfPCell prog4 = new PdfPCell(new Phrase(Math.Round(Rollos, 1).ToString(), new Font(Font.FontFamily.HELVETICA, 8)));
                        prog4.Border = 1;
                        prog4.HorizontalAlignment = Element.ALIGN_LEFT;
                        tablaDatosPre.AddCell(prog4);
                    ...
                    PdfPCell celdatitinse = new PdfPCell(new Phrase("Insumos: ", new Font(Font.FontFamily.HELVETICA, 8, Font.BOLD, new BaseColor(System.Drawing.Color.Brown))));
                    ...
                    //if (embobinado.UsaInsumos)
                    //{
                    //    List<VArticulosProduccion> articulosproduccionie = new ArticulosProduccionContext().Database.SqlQuery<VArticulosProduccion>("select AP.Existe,Ap.Cantidad as Cantidad, A.Cref as Cref,AP.IDArtProd,A.Descripcion as Articulo,TA.Descripcion as TipoArticulo,C.Presentacion as Caracteristica,P.NombreProceso as Proceso,AP.IDOrden,AP.Cantidad,CU.Nombre as Unidad,AP.Indicaciones,AP.CostoPlaneado,AP.CostoReal, AP.IDHE from ArticuloProduccion as AP inner join Articulo as A on A.IDArticulo=AP.IDArticulo inner join TipoArticulo as TA on A.IDTipoArticulo=TA.IDTipoArticulo inner join Caracteristica as C on C.ID=AP.IDCaracteristica inner join Proceso as P on P.IDProceso=AP.IDProceso inner join c_ClaveUnidad as CU on CU.IDClaveUnidad=AP.IDClaveUnidad where AP.IDOrden=" + id + " and AP.IDProceso=" + embobinado.IDProceso + " and (TA.Descripcion='Insumo' ) ").ToList();
                    //    if (articulosproduccionie.Count > 0)
                    //    {

                    float[] anchoColumnasTablaProductos = { 60 };
                    PdfPTable tablaProductosCentro = new PdfPTable(anchoColumnasTablaProductos);
                    //tablaProductosPrincipal.DefaultCell.Border = Rectangle.NO_BORDER;
                    tablaProductosCentro.SetTotalWidth(anchoColumnasTablaProductos);
                    tablaProductosCentro.SpacingBefore = 10;
                    tablaProductosCentro.SpacingAfter = 5;
                    tablaProductosCentro.HorizontalAlignment = Element.ALIGN_LEFT;
                    tablaProductosCentro.LockedWidth = true;

                    PdfPCell celdacentrotit = new PdfPCell(new Phrase("CENTRO", new Font(Font.FontFamily.HELVETICA, 8, Font.BOLD, colorencabezadodefinido)));
                    celdacentrotit.BackgroundColor = colordefinido;
                    tablaProductosCentro.AddCell(celdacentrotit);
                    PdfPCell celdac01 = new PdfPCell(new Phrase(Centro, new Font(Font.FontFamily.HELVETICA, 8, Font.BOLD)));
                    tablaProductosCentro.AddCell(celdac01);


                    PdfPCell celda00 = new PdfPCell(tablaProductosCentro);
        ...
        public PdfPTable agregaarticulossuaje(List<VArticulosProduccion> articulosproduccion, string proceso, float anchocolumna)
        {
            ...
            foreach (VArticulosProduccion p in articulosproduccion)
            {
                if (p.IDCaracteristica != 12571)
                {
                    ...
                    suaje = getSuaje(p.IDCaracteristica);


                    string THALMA = "";
                    if (suaje.TH != 0)
                    {
                        THALMA = suaje.TH.ToString();
                    }
                    if (suaje.THAlma != "")
                    {
                        THALMA = suaje.THAlma;
                    ...
                    try
                    {
                        cadena2suaje = "CAV EJE: " + suaje.CavidadEje + " EJE: " + suaje.Eje + " AVANCE: " + suaje.Avance + " GAP EJE " + suaje.Gapeje + " GAP AVA " + suaje.Gapavance + " TH " + THALMA;
                    }
                    catch (Exception err)
                    {
                    ...
                    Caracteristica cara = new ArticuloContext().Database.SqlQuery<Caracteristica>("Select * from Caracteristica where ID=" + p.IDCaracteristica).ToList().FirstOrDefault();

                    //if (cara.Presentacion.Contains("PLECA:SI"))
                    //{
                    //    FormulaSiaapi.Formulas formu = new FormulaSiaapi.Formulas();
                    //    cadena2suaje += " PLECA :" + formu.getValorCadena("CLAVE P", cara.Presentacion);
                    //}



                    PdfPCell celda01 = new PdfPCell(new Phrase(Cref + " " + p.Articulo, new Font(Font.FontFamily.HELVETICA, 8, Font.BOLD)));
                    PdfPCell celda02 = new PdfPCell(new Phrase(cadena2suaje, new Font(Font.FontFamily.HELVETICA, 8, Font.BOLD)));

                    tablaProductosTitulos.AddCell(celda01);
                    tablaProductosTitulos.AddCell(celda02);
        ...
        private void AgregarDatosEntrega(int id)
        {
            ...
            p2.Add(new Phrase("FSG-40", new Font(Font.FontFamily.HELVETICA, 8)));
        ...
        private void AgregarDatosCalidad(int id)
        {
            ...
            PdfPCell Nivel = new PdfPCell(new Phrase("Nivel de Inspección", new Font(Font.FontFamily.HELVETICA, 8, Font.BOLD, colorencabezadodefinido)));
            PdfPCell muest = new PdfPCell(new Phrase("Tamaño de muestra", new Font(Font.FontFamily.HELVETICA, 8, Font.BOLD, colorencabezadodefinido)));
            PdfPCell AC = new PdfPCell(new Phrase("Ac", new Font(Font.FontFamily.HELVETICA, 8, Font.BOLD, colorencabezadodefinido)));
            PdfPCell RE = new PdfPCell(new Phrase("Re", new Font(Font.FontFamily.HELVETICA, 8, Font.BOLD, colorencabezadodefinido)));
        ...
        public SuajeCaracteristicas getSuaje(int IDSuaje)
        {
            ...
            suajec.THAlma = "";
            if (suajec.TH == 0 || suajec.THAlma=="")
            {
                try
                {
                    suajec.THAlma = formula.getValorCadena("TH", cara.Presentacion).ToString();
    ...
    public class ITextEventsOrdenProduccion : PdfPageEventHelper
    {
