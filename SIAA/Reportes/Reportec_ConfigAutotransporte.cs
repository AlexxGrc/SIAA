...
{
    public class Reportec_ConfigAutotransporte
    {
        // System.Drawing.Font;
        #region Declaration
        ...
        #endregion
        public c_ConfigAutotransporteDBContext db = new c_ConfigAutotransporteDBContext();
        public List<c_ConfigAutotransporte> ConfigAuto = new List<c_ConfigAutotransporte>();
        ...
        private void ReportHeader()
        {
            ...
            paragraph.Add("Catalogo ConfigAutotransporte");
            ...
            //_fontStyle = FontFactory.GetFont("Tahoma", 8f, COLORDEFUENTEREPORTE);
            _PdfPCell = new PdfPCell(new Phrase("Fecha Inicio", _fontStyleEncabezado));
            _PdfPCell.Border = 0;
            _PdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            _PdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _PdfPCell.BackgroundColor = COLORDEREPORTE;
            ...
            //_fontStyle = FontFactory.GetFont("Tahoma", 8f, COLORDEFUENTEREPORTE);
            _PdfPCell = new PdfPCell(new Phrase("Fecha Fin", _fontStyleEncabezado));
            _PdfPCell.Border = 0;
            _PdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            _PdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _PdfPCell.BackgroundColor = COLORDEREPORTE;
        ...
        private void ReportBody()
        {
            ...
            foreach (c_ConfigAutotransporte b in ConfigAuto)
            {
                ...
                PdfPCell _PdfPCell1 = new PdfPCell(new Phrase(b.ClaveNom, _fontStylecliente));
                _PdfPCell1.Border = 0;
                ...
                _PdfPCell = new PdfPCell(new Phrase(b.NoEjes, _fontStyle));
                _PdfPCell.Border = 0;
                tablaConfig.AddCell(_PdfPCell);

                _fontStyle = FontFactory.GetFont("Tahoma", 10f, 1);
                _PdfPCell = new PdfPCell(new Phrase(b.NoLlantas, _fontStyle));
                _PdfPCell.Border = 0;
                tablaConfig.AddCell(_PdfPCell);
