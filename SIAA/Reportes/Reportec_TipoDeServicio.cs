...
{
    public class Reportec_TipoDeServicio
    {
        ...
        #endregion
        public c_TipoDeServicioContext db = new c_TipoDeServicioContext();
        public List<c_TipoDeServicio> Tservicio = new List<c_TipoDeServicio>();
...

        {
            ...
            HttpContext.Current.Response.AddHeader("content-disposition", "attachment; filename=\"ReporteTipoDeServicio.pdf" + "\"");
        ...
        private void ReportBody()
        {
            ...
            foreach (c_TipoDeServicio b in Tservicio)
            {
