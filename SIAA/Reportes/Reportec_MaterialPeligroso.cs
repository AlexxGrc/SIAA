...
{
    public class Reportec_MaterialPeligroso
    {
        ...
        #endregion
        public c_MaterialPeligrosoDBContext db = new c_MaterialPeligrosoDBContext();
        public List<c_MaterialPeligroso> Material = new List<c_MaterialPeligroso>();
...

        {
            ...
            HttpContext.Current.Response.AddHeader("content-disposition", "attachment; filename=\"ReporteMatP.pdf" + "\"");
        ...
        private void ReportHeader()
        {
            ...
            paragraph.Add("Catálogo Material Peligroso");
            ...
            float[] anchoColumnasencart = { 60f, 150f, 70f, 30f, 65f, 90f, 65f, 70f };
            ...
            //_fontStyle = FontFactory.GetFont("Tahoma", 8f, COLORDEFUENTEREPORTE);
            _PdfPCell = new PdfPCell(new Phrase("Inst. de emb/env", _fontStyleEncabezado));
            _PdfPCell.Border = 0;
            _PdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            _PdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _PdfPCell.BackgroundColor = COLORDEREPORTE;
            ...
            //_fontStyle = FontFactory.GetFont("Tahoma", 8f, COLORDEFUENTEREPORTE);
            _PdfPCell = new PdfPCell(new Phrase("RIG", _fontStyleEncabezado));
            _PdfPCell.Border = 0;
            _PdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            _PdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _PdfPCell.BackgroundColor = COLORDEREPORTE;
            ...
            //_fontStyle = FontFactory.GetFont("Tahoma", 8f, COLORDEFUENTEREPORTE);
            _PdfPCell = new PdfPCell(new Phrase("Cisternas", _fontStyleEncabezado));
            _PdfPCell.Border = 0;
            _PdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            _PdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _PdfPCell.BackgroundColor = COLORDEREPORTE;
            ...
            //_fontStyle = FontFactory.GetFont("Tahoma", 8f, COLORDEFUENTEREPORTE);
            _PdfPCell = new PdfPCell(new Phrase("Contenedores", _fontStyleEncabezado));
            _PdfPCell.Border = 0;
            _PdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            _PdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _PdfPCell.BackgroundColor = COLORDEREPORTE;
            ...
            //_fontStyle = FontFactory.GetFont("Tahoma", 8f, COLORDEFUENTEREPORTE);
            _PdfPCell = new PdfPCell(new Phrase("Fecha_In", _fontStyleEncabezado));
            _PdfPCell.Border = 0;
            _PdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            _PdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _PdfPCell.BackgroundColor = COLORDEREPORTE;
            ...
            //_fontStyle = FontFactory.GetFont("Tahoma", 8f, COLORDEFUENTEREPORTE);
            _PdfPCell = new PdfPCell(new Phrase("Fecha_Fin", _fontStyleEncabezado));
            _PdfPCell.Border = 0;
            _PdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            _PdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _PdfPCell.BackgroundColor = COLORDEREPORTE;
        ...
        private void ReportBody()
        {
            ...
            foreach (c_MaterialPeligroso b in Material)
            {
                ...
                float[] anchoColumnasMat = { 50f, 155f, 65f, 45f, 70f, 65f, 65f, 65f };

                // 50 para id 3000 para el nombre 100 para el telefono y 150 para el vendedor


                PdfPTable tablaMatP = new PdfPTable(anchoColumnasMat);
                //tablaProductosPrincipal.DefaultCell.Border = Rectangle.NO_BORDER;
                tablaMatP.SetTotalWidth(anchoColumnasMat);
                tablaMatP.SpacingBefore = 3;
                tablaMatP.HorizontalAlignment = Element.ALIGN_LEFT;
                tablaMatP.LockedWidth = true;
                ...
                PdfPCell _PdfPCell1 = new PdfPCell(new Phrase(b.ClaveMatP, _fontStylecliente));
                _PdfPCell1.Border = 0;
                ...
                tablaMatP.AddCell(_PdfPCell1);

                PdfPCell _PdfPCell4 = new PdfPCell(new Phrase(b.Descripcion, _fontStylecliente));
                _PdfPCell4.Border = 0;
                ...
                tablaMatP.AddCell(_PdfPCell4);


                _fontStyle = FontFactory.GetFont("Tahoma", 10f, 1);
                _PdfPCell = new PdfPCell(new Phrase(b.Embalaje, _fontStyle));
                _PdfPCell.Border = 0;
                tablaMatP.AddCell(_PdfPCell);

                _fontStyle = FontFactory.GetFont("Tahoma", 10f, 1);
                _PdfPCell = new PdfPCell(new Phrase(b.RIG, _fontStyle));
                _PdfPCell.Border = 0;
                tablaMatP.AddCell(_PdfPCell);

                _fontStyle = FontFactory.GetFont("Tahoma", 10f, 1);
                _PdfPCell = new PdfPCell(new Phrase(b.Cisternas, _fontStyle));
                _PdfPCell.Border = 0;
                tablaMatP.AddCell(_PdfPCell);

                _fontStyle = FontFactory.GetFont("Tahoma", 10f, 1);
                _PdfPCell = new PdfPCell(new Phrase(b.Contenedores, _fontStyle));
                _PdfPCell.Border = 0;
                tablaMatP.AddCell(_PdfPCell);

                _fontStyle = FontFactory.GetFont("Tahoma", 10f, 1);
                _PdfPCell = new PdfPCell(new Phrase(b.Fecha_In.ToString("dd/MM/yyyy"), _fontStyle));
                _PdfPCell.Border = 0;
                tablaMatP.AddCell(_PdfPCell);

                _fontStyle = FontFactory.GetFont("Tahoma", 10f, 1);
                _PdfPCell = new PdfPCell(new Phrase(b.Fecha_Fin.ToString(), _fontStyle));
                _PdfPCell.Border = 0;
                tablaMatP.AddCell(_PdfPCell);

                _documento.Add(tablaMatP);
