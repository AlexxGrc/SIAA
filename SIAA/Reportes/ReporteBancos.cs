...
namespace SIAAPI.Reportes
{
    public class ReporteBancos
    {
       ...
       // List<c_Banco> articulos = new List<c_Banco>();
        #endregion
        public c_BancoContext db = new c_BancoContext();
        public List<c_Banco> Bancos = new List<c_Banco>();
...
//se modifico de aquí
            ...
            paragraph.Add("Catalogo de Bancos");
...
//Aquí termina la modificación del encabezado
            ...
            //_fontStyle = FontFactory.GetFont("Tahoma", 8f, COLORDEFUENTEREPORTE);
            _PdfPCell = new PdfPCell(new Phrase("Razón Social", _fontStyleEncabezado));
            _PdfPCell.Border = 0;
            _PdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            _PdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _PdfPCell.BackgroundColor = COLORDEREPORTE;
            ...
            //_fontStyle = FontFactory.GetFont("Tahoma", 8f, COLORDEFUENTEREPORTE);
            _PdfPCell = new PdfPCell(new Phrase("RFC", _fontStyleEncabezado));
            _PdfPCell.Border = 0;
            _PdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            _PdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _PdfPCell.BackgroundColor = COLORDEREPORTE;
        ...
        private void ReportBody()
        {
            ...
            foreach (c_Banco b in Bancos)
            {
                ...
                float[] anchoColumnasBancos = { 80f, 150f, 270f, 100f };
                ...
                PdfPCell _PdfPCell1 = new PdfPCell(new Phrase(b.ClaveBanco, _fontStylecliente));
                _PdfPCell1.Border = 0;
                ...
                PdfPCell _PdfPCell4 = new PdfPCell(new Phrase(b.Nombre, _fontStylecliente));
                _PdfPCell4.Border = 0;
                ...
                _PdfPCell = new PdfPCell(new Phrase(b.RazonSocial, _fontStyle));
                _PdfPCell.Border = 0;
                tablaBancos.AddCell(_PdfPCell);

                _fontStyle = FontFactory.GetFont("Tahoma", 10f, 1);
                _PdfPCell = new PdfPCell(new Phrase(b.RFC, _fontStyle));
                _PdfPCell.Border = 0;
                tablaBancos.AddCell(_PdfPCell);
