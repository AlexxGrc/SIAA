...
{
    public class Reportec_Localidad
    {
        #region Declaration
        ...
        #endregion
        public c_LocalidadContext db = new c_LocalidadContext();
        public List<c_Localidad> C_L = new List<c_Localidad>();
...

        {
            ...
            HttpContext.Current.Response.AddHeader("content-disposition", "attachment; filename=\"ReporteLocalidad.pdf" + "\"");
        ...
        private void ReportHeader()
        {
            ...
            _PdfPCell = new PdfPCell(new Phrase("Localidad", _fontStyleEncabezado));
            _PdfPCell.Border = 0;
        ...
        private void ReportBody()
        {
            ...
            foreach (c_Localidad b in C_L)
            {
                ...
                float[] anchoColumnasBancos = { 200f, 200f, 200f };
                ...
                PdfPCell _PdfPCell1 = new PdfPCell(new Phrase(b.C_Localidad, _fontStylecliente));
                _PdfPCell1.Border = 0;
                ...
                _PdfPCell = new PdfPCell(new Phrase(b.C_Estado, _fontStyle));
                _PdfPCell.Border = 0;
