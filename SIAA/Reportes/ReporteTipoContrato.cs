...
{
    public class ReporteTipoContrato
    {
        #region Declaration
        ...
        #endregion
        public c_TipoContratoContext db = new c_TipoContratoContext();
        public List<c_TipoContrato> tipoContrato = new List<c_TipoContrato>();
...

        {
            ...
            HttpContext.Current.Response.AddHeader("content-disposition", "attachment; filename=\"ReporteTipoContrato.pdf" + "\"");
        ...
        private void ReportHeader()
        {
            ...
            p1.Leading = 20;
            p1.Add(new Phrase("Catalogo Tipo de Contrato", new Font(Font.FontFamily.HELVETICA, 20, Font.BOLD)));
            p1.SpacingAfter = 40;
            _documento.Add(p1);
            ...
            Font _fontStyleEncabezado = FontFactory.GetFont("Tahoma", 13f, COLORDEFUENTEREPORTE);
                ...
                _PdfPCell = new PdfPCell(new Phrase("Clave Jornada", _fontStyleEncabezado));
                _PdfPCell.Border = 0;
        ...
        private void ReportBody()
        {
            ...
            //  
                ...
                foreach (c_TipoContrato b in tipoContrato)
                {
                    ...
                    float[] anchoColumnastipoContrato= { 100f, 500f };

                    // 50 para id 3000 para el nombre 100 para el telefono y 150 para el vendedor

                    PdfPTable tablatipoCon = new PdfPTable(anchoColumnastipoContrato);
                //tablaProductosPrincipal.DefaultCell.Border = Rectangle.NO_BORDER;
                tablatipoCon.SetTotalWidth(anchoColumnastipoContrato);
                ...
                tablatipoCon.LockedWidth = true;
                    ...
                    PdfPCell _PdfPCell1 = new PdfPCell(new Phrase(b.ClaveTipoContrato, _fontStylecliente));
                    _PdfPCell1.Border = 0;
