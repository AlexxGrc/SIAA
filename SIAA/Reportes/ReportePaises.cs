...
{
    public class ReportePaises
    {
        public PaisesContext pai = new PaisesContext();
        public List<Paises> ps = new List<Paises>();
        ...
        List<Paises> articulos = new List<Paises>();
        #endregion
...

        {
            ...
            HttpContext.Current.Response.AddHeader("content-disposition", "attachment; filename=\"ReportePaises.pdf" + "\"");
        ...
        private void ReportHeader()
        {
            ...
            p1.Leading = 20;
            p1.Add(new Phrase("Catalogo Paises", new Font(Font.FontFamily.HELVETICA, 20, Font.BOLD)));
            p1.SpacingAfter = 40;
            _documento.Add(p1);
        ...
        private void ReportBody()
        {
            ...
            foreach (Paises p in ps)
            {
                ...
                float[] anchoColumnasTipoIva = { 100f, 400f };

                // 50 para id 3000 para el nombre 100 para el telefono y 150 para el vendedor


                PdfPTable tablaRegimenFiscal = new PdfPTable(anchoColumnasTipoIva);
                //tablaProductosPrincipal.DefaultCell.Border = Rectangle.NO_BORDER;
                tablaRegimenFiscal.SetTotalWidth(anchoColumnasTipoIva);
                ...
                PdfPCell _PdfPCell1 = new PdfPCell(new Phrase(p.Codigo, _fontStylecliente));
                _PdfPCell1.Border = 0;
                ...
                PdfPCell _PdfPCell2 = new PdfPCell(new Phrase(p.Pais, _fontStylecliente));
                _PdfPCell2.Border = 0;
