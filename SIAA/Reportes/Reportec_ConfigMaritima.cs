...
namespace SIAAPI.Reportes
{
    ...
    public class Reportec_ConfigMaritima
    {
        #region Declaration
        ...
        #endregion
        public c_ConfigMaritimaContext db = new c_ConfigMaritimaContext();
        public List<c_ConfigMaritima> ClaveCM = new List<c_ConfigMaritima>();
...

        {
            ...
            HttpContext.Current.Response.AddHeader("content-disposition", "attachment; filename=\"ReporteConfigMaritima.pdf" + "\"");
        ...
        private void ReportHeader()
        {
            ...
            paragraph.Add("Configuración Marítima");
        ...
        private void ReportBody()
        {
            ...
            foreach (c_ConfigMaritima b in ClaveCM)
            {
