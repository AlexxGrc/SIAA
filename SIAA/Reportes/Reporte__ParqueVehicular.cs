...
{
    public class Reporte__ParqueVehicular
    {
        // System.Drawing.Font;
        #region Declaration
        ...
        #endregion
        public ParqueVehicularDBContext db = new ParqueVehicularDBContext();
        public List<ParqueVehicular> ParqueVeh = new List<ParqueVehicular>();
...

        {
            ...
            HttpContext.Current.Response.AddHeader("content-disposition", "attachment; filename=\"ReporteBancos.pdf" + "\"");
        ...
        private void ReportHeader()
        {
            ...
            paragraph.Add("Catálogo Parque Vehícular");
            ...
            float[] anchoColumnasencart = { 70f, 230f, 60f, 60f, 90f, 90f };
            ...
            _PdfPCell = new PdfPCell(new Phrase("ClaveNom", _fontStyleEncabezado));
            _PdfPCell.Border = 0;
            ...
            //_fontStyle = FontFactory.GetFont("Tahoma", 8f, COLORDEFUENTEREPORTE);
            _PdfPCell = new PdfPCell(new Phrase("No. Ejes", _fontStyleEncabezado));
            _PdfPCell.Border = 0;
            _PdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            _PdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _PdfPCell.BackgroundColor = COLORDEREPORTE;
            ...
            //_fontStyle = FontFactory.GetFont("Tahoma", 8f, COLORDEFUENTEREPORTE);
            _PdfPCell = new PdfPCell(new Phrase("No. Llantas", _fontStyleEncabezado));
            _PdfPCell.Border = 0;
            _PdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            _PdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _PdfPCell.BackgroundColor = COLORDEREPORTE;
        ...
        private void ReportBody()
        {
            ...
            foreach (ParqueVehicular b in ParqueVeh)
            {
                ...
                float[] anchoColumnasConfig = { 60f, 235f, 60f, 70f, 85f, 85f };

                // 50 para id 3000 para el nombre 100 para el telefono y 150 para el vendedor


                PdfPTable tablaConfig = new PdfPTable(anchoColumnasConfig);
                //tablaProductosPrincipal.DefaultCell.Border = Rectangle.NO_BORDER;
                tablaConfig.SetTotalWidth(anchoColumnasConfig);
                tablaConfig.SpacingBefore = 3;
                tablaConfig.HorizontalAlignment = Element.ALIGN_LEFT;
                tablaConfig.LockedWidth = true;
                ...
                PdfPCell _PdfPCell1 = new PdfPCell(new Phrase(b.ClavePermisoSCT, _fontStylecliente));
                _PdfPCell1.Border = 0;
                ...
                tablaConfig.AddCell(_PdfPCell1);

                PdfPCell _PdfPCell4 = new PdfPCell(new Phrase(b.Aseguradora, _fontStylecliente));
                _PdfPCell4.Border = 0;
                ...
                tablaConfig.AddCell(_PdfPCell4);


                _fontStyle = FontFactory.GetFont("Tahoma", 10f, 1);
                _PdfPCell = new PdfPCell(new Phrase(b.PolizaSeguro, _fontStyle));
                _PdfPCell.Border = 0;
                tablaConfig.AddCell(_PdfPCell);

                _fontStyle = FontFactory.GetFont("Tahoma", 10f, 1);
                _PdfPCell = new PdfPCell(new Phrase(b.ClaveVehiculo, _fontStyle));
                _PdfPCell.Border = 0;
                tablaConfig.AddCell(_PdfPCell);

                _fontStyle = FontFactory.GetFont("Tahoma", 10f, 1);
                _PdfPCell = new PdfPCell(new Phrase(b.PlacaVehiculo, _fontStyle));
                _PdfPCell.Border = 0;
                tablaConfig.AddCell(_PdfPCell);

                _fontStyle = FontFactory.GetFont("Tahoma", 10f, 1);
                _PdfPCell = new PdfPCell(new Phrase(b.Modelo, _fontStyle));
                _PdfPCell.Border = 0;
                tablaConfig.AddCell(_PdfPCell);

                _documento.Add(tablaConfig);
