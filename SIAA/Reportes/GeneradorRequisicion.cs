...
namespace SIAAPI.Reportes
{
    ...
    public class ImpuestoRequisicion
    {
    ...
    public class RetencionRequisicion
    {
        public string impuesto;
        public float importe;
    }

    public class DocumentoRequisicion
    {
        ...
        public List<ProductoRequisicion> productos = new List<ProductoRequisicion>();
        public List<ImpuestoRequisicion> impuestos = new List<ImpuestoRequisicion>();
        public List<RetencionRequisicion> retenciones = new List<RetencionRequisicion>();
    ...
    public class CreaRequisicionPDF
    {
        ...
        public DocumentoRequisicion _templatePDF; //Objeto que contendra la información del documento pdf
        XmlDocument xDoc; // Objeto para abrir el archivo xml

        public CreaRequisicionPDF( System.Drawing.Image logo, DocumentoRequisicion Encrequisicion)
        {
            _templatePDF = Encrequisicion;
            ObtenerLetras();
            ...
            HttpContext.Current.Response.AddHeader("content-disposition", "attachment;" + "filename=Requisicion" + _templatePDF.serie + _templatePDF.folio + ".pdf");
        ...
        private void AgregarLogo(System.Drawing.Image logoEmpresa)
        {
                       ...
                       try
            {
                ...
                imagen.SetAbsolutePosition(15f, (_documento.PageSize.Height - 60));
        ...
        private void AgregaPropiedadesDocumento()
        {
            ...
            _documento.AddKeywords("REQUISICION");
            _documento.AddSubject("Requisicion");
            _documento.AddTitle("REQUISICION");
        ...
        private void AgregarDatosReceptor()
        {
            ...
            PdfPCell celda1= new PdfPCell( new Phrase(_templatePDF.Proveedor.ToUpper(), new Font(Font.FontFamily.HELVETICA, 8)));
        ...
        private void AgregarDatosProductos()
        {
            ...
            foreach (ProductoRequisicion p in _templatePDF.productos)
            {
        ...
        private void AgregarTotales()
        {
            ...
            foreach (ImpuestoRequisicion i in _templatePDF.impuestos)
            {
            ...
            foreach (RetencionRequisicion i in _templatePDF.retenciones)
            {
            ...
            float[] anchoColumnasoFirmas = { 300f, 300f };
    ...
    public class ITextEvents : PdfPageEventHelper
    {
        ...
        public override void OnEndPage(iTextSharp.text.pdf.PdfWriter writer, iTextSharp.text.Document document)
        {
         ...
         
            {
                ...
                tabla.AddCell(new Phrase("Este documento es una Requisicion ", new Font(Font.FontFamily.HELVETICA, 10)));
