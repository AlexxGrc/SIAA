...
{
    public class ReporteProductoServicios
    {
        #region Declaration
        ...
        #endregion
        public c_ClaveProductoServicioContext db = new c_ClaveProductoServicioContext();
        public List<c_ClaveProductoServicio> ProductoServicio = new List<c_ClaveProductoServicio>();
...

        {
            ...
            HttpContext.Current.Response.AddHeader("content-disposition", "attachment; filename=\"ReporteProductoServicio.pdf" + "\"");
        ...
        private void ReportHeader()
        {
            ...
            p1.Leading = 20;
            p1.Add(new Phrase("Catalogo de Producto o Servicio", new Font(Font.FontFamily.HELVETICA, 20, Font.BOLD)));
            p1.SpacingAfter = 40;
            _documento.Add(p1);
            ...
            float[] anchoColumnasencart = { 100f, 500f };//Se cambia
        ...
        private void ReportBody()
        {
            ...
            //  
                ...
                foreach (c_ClaveProductoServicio b in ProductoServicio)
                {
                    ...
                    float[] anchoColumnasProdServ= { 100f, 500f };

                    // 50 para id 3000 para el nombre 100 para el telefono y 150 para el vendedor

                    PdfPTable tablaProduServ = new PdfPTable(anchoColumnasProdServ);
                //tablaProductosPrincipal.DefaultCell.Border = Rectangle.NO_BORDER;
                tablaProduServ.SetTotalWidth(anchoColumnasProdServ);
                tablaProduServ.SpacingBefore = 3;
                tablaProduServ.HorizontalAlignment = Element.ALIGN_LEFT;
                tablaProduServ.LockedWidth = true;
                    ...
                    PdfPCell _PdfPCell1 = new PdfPCell(new Phrase(b.ClaveProdServ, _fontStylecliente));
                    _PdfPCell1.Border = 0;
                ...
                tablaProduServ.AddCell(_PdfPCell1);
                ...
                tablaProduServ.AddCell(_PdfPCell2);

                _documento.Add(tablaProduServ);
