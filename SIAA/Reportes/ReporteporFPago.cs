...
namespace SIAAPI.Reportes
{
    public class ReporteporFPago
    {
        ...
        public byte[] PrepareReport(DateTime _fechaini, DateTime _fechafin, string _pago, string _esta, string _nota)
        {
            fechaini = _fechaini;
            fechafin = _fechafin;
            idPago = _pago;
            ...
            HttpContext.Current.Response.AddHeader("content-disposition", "attachment; filename=\"ReporteFechaPago.pdf" + "\"");
        ...
        public List<ReportefenoClie> GetFacturas()
        {
            ...
            try
            {
                if (status == "T")
                {
                    ...
                    if (idPago != "0")
                    {
                        cadena = cadena + " and ClaveFormaPago=" + idPago +"";
                    }
        ...
        private void ReportHeader()
        {
            ...
            _PdfPCell = new PdfPCell(new Phrase("Reporte por Forma de Pago", _fontStyle));
    ...
    public class ITextEventsRepLFacs : PdfPageEventHelper
    {
    ...
    public class fechasReporteFacs
    {
