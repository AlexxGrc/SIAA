...
{
    public class ReporteporFechaProv
    {
        #region Declaration
        ...
        public byte[] PrepareReport(DateTime _fechaini, DateTime _fechafin, int _idProveedor, string _esta, string _nota)
        {
            fechaini = _fechaini;
            fechafin = _fechafin;
            ...
            HttpContext.Current.Response.AddHeader("content-disposition", "attachment; filename=\"ListadoPorFechaProveedores.pdf" + "\"");
        ...
        public List<ReportefenoProv> GetFacturas()
        {
            ...
            try
            {
                ...
                {
                    string cadena = "select ID,FechaPago, SerieP, FolioP,  RFC,Empresa, ClaveFormaPago, Descripcion as FormaPago, ClaveDivisa, NoOperacion, Monto, RFCBancoEmisor, NombreBancoEmisor, CuentaEmisor, RFCBancoReceptor,NombreBancoReceptor, CuentaReceptor, IDTipoCadenaPago,Estado, UUID from VPagoFacturaProvT";
                    cadena = cadena + " where FechaPago>='" + fechaini.Year + "/" + fechaini.Month + "/" + fechaini.Day + " 00:00:01' and FechaPago <='" + fechafin.Year + "/" + fechafin.Month + "/" + fechafin.Day + " 23:59:59' and IDProveedor=" + idProveedor + "and Estado=1";
                    facturas = db.Database.SqlQuery<ReportefenoProv>(cadena).ToList();
                }
                if (status == "C")
                {
                    string cadena = "select ID,FechaPago, SerieP, FolioP,  RFC,Empresa, ClaveFormaPago, Descripcion as FormaPago, ClaveDivisa, NoOperacion, Monto, RFCBancoEmisor, NombreBancoEmisor, CuentaEmisor, RFCBancoReceptor,NombreBancoReceptor, CuentaReceptor, IDTipoCadenaPago,Estado, UUID from VPagoFacturaProvT";
                    cadena = cadena + " where FechaPago>='" + fechaini.Year + "/" + fechaini.Month + "/" + fechaini.Day + " 00:00:01' and FechaPago <='" + fechafin.Year + "/" + fechafin.Month + "/" + fechafin.Day + " 23:59:59' and IDProveedor=" + idProveedor + "and Estado=0";
                    facturas = db.Database.SqlQuery<ReportefenoProv>(cadena).ToList();
                }
            }
        ...
        private void ReportHeader()
        {
            ...
            _PdfPCell = new PdfPCell(new Phrase("Reporte por Fecha Proveedores", _fontStyle));
    ...
    public class ITextEventsRepLFacP : PdfPageEventHelper
    {
    ...
    public class fechasReporteFacP
    {
