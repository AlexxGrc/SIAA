...
{
    public class ReporteClaveUnidad
    {
        #region Declaration
        ...
        #endregion
        public c_ClaveUnidadContext db = new c_ClaveUnidadContext();
        public List<c_ClaveUnidad> claveUnidad = new List<c_ClaveUnidad>();
...

        {
            ...
            HttpContext.Current.Response.AddHeader("content-disposition", "attachment; filename=\"ReporteClaveUnidad.pdf" + "\"");
        ...
        private void ReportHeader()
        {
            ...
            p1.Leading = 20;
            p1.Add(new Phrase("Catalogo Uso de CFDI", new Font(Font.FontFamily.HELVETICA, 20, Font.BOLD)));
            p1.SpacingAfter = 40;
            _documento.Add(p1);
        ...
        private void ReportBody()
        {
            ...
            //  
                ...
                foreach (c_ClaveUnidad b in claveUnidad)
                {
                    ...
                    float[] anchoColumnasclaveUnidad= { 100f, 500f };

                    // 50 para id 3000 para el nombre 100 para el telefono y 150 para el vendedor

                    PdfPTable tablatipoCon = new PdfPTable(anchoColumnasclaveUnidad);
                //tablaProductosPrincipal.DefaultCell.Border = Rectangle.NO_BORDER;
                tablatipoCon.SetTotalWidth(anchoColumnasclaveUnidad);
