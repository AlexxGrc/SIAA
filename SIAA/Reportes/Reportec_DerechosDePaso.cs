...
{
    public class Reportec_DerechosDePaso
    {
        ...
        #endregion
        public c_DerechosDePasoContext db = new c_DerechosDePasoContext();
        public List<c_DerechosDePaso> Derechop = new List<c_DerechosDePaso>();
        ...
        public byte[] PrepareReport()
        {
            ...
            HttpContext.Current.Response.AddHeader("content-disposition", "attachment; filename=\"ReporteDerechodePaso.pdf" + "\"");
        ...
        private void ReportHeader()
        {
            ...
            paragraph.Add("Derechos de paso ");
            ...
            float[] anchoColumnasencart = { 60f, 80f, 120f, 140f, 100f, 100f };
            ...
            _fontStyle = FontFactory.GetFont("Tahoma", 8f, COLORDEFUENTEREPORTE);
            _PdfPCell = new PdfPCell(new Phrase("Derechos de paso", _fontStyleEncabezado));
            _PdfPCell.Border = 0;
            _PdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            _PdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _PdfPCell.BackgroundColor = COLORDEREPORTE;
            ...
            _fontStyle = FontFactory.GetFont("Tahoma", 8f, COLORDEFUENTEREPORTE);
            _PdfPCell = new PdfPCell(new Phrase("Entre", _fontStyleEncabezado));
            _PdfPCell.Border = 0;
            _PdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            _PdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _PdfPCell.BackgroundColor = COLORDEREPORTE;
            ...
            _fontStyle = FontFactory.GetFont("Tahoma", 8f, COLORDEFUENTEREPORTE);
            _PdfPCell = new PdfPCell(new Phrase("Hasta", _fontStyleEncabezado));
            _PdfPCell.Border = 0;
            _PdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            _PdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _PdfPCell.BackgroundColor = COLORDEREPORTE;
        ...
        private void ReportBody()
        {
            ...
            foreach (c_DerechosDePaso b in Derechop)
            {
                ...
                float[] anchoColumnasBancos = { 60f, 100f, 100f, 140f, 100f, 100f };
                ...
                PdfPCell _PdfPCell1 = new PdfPCell(new Phrase(b.ClavePaso, _fontStylecliente));
                _PdfPCell1.Border = 0;
                ...
                _PdfPCell = new PdfPCell(new Phrase(b.DerechoPaso, _fontStyle));
                _PdfPCell.Border = 0;
                tablaBancos.AddCell(_PdfPCell);

                _fontStyle = FontFactory.GetFont("Tahoma", 10f, 1);
                _PdfPCell = new PdfPCell(new Phrase(b.Entre, _fontStyle));
                _PdfPCell.Border = 0;
                tablaBancos.AddCell(_PdfPCell);

                _fontStyle = FontFactory.GetFont("Tahoma", 10f, 1);
                _PdfPCell = new PdfPCell(new Phrase(b.Hasta, _fontStyle));
                _PdfPCell.Border = 0;
                tablaBancos.AddCell(_PdfPCell);
