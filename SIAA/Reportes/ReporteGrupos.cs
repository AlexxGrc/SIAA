...
namespace SIAAPI.Reportes
{
    public class ReporteGrupos
    {
        ...
        #endregion
        public c_Grupo db = new c_Grupo();
        public List<c_Grupo> grupo = new List<c_Grupo>();
...

        {
            ...
            HttpContext.Current.Response.AddHeader("content-disposition", "attachment; filename=\"ReporteGrupos.pdf" + "\"");
        ...
        private void ReportHeader()
        {
            ...
            paragraph.Add("Catalogo de Grupos");
            ...
            float[] anchoColumnasencart = { 200f, 400f };
            ...
            //_fontStyle = FontFactory.GetFont("Tahoma", 8f, COLORDEFUENTEREPORTE);
            _PdfPCell = new PdfPCell(new Phrase("Clave Grupo", _fontStyleEncabezado));
            _PdfPCell.Border = 0;
            _PdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            _PdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _PdfPCell.BackgroundColor = COLORDEREPORTE;
        ...
        private void ReportBody()
        {
            ...
            foreach (c_Grupo i in grupo)
            {
                ...
                float[] anchoColumnasGrupo = { 200f, 400f };

                // 50 para id 3000 para el nombre 100 para el telefono y 150 para el vendedor


                PdfPTable tablaGrupo = new PdfPTable(anchoColumnasGrupo);
                //tablaProductosPrincipal.DefaultCell.Border = Rectangle.NO_BORDER;
                tablaGrupo.SetTotalWidth(anchoColumnasGrupo);
                tablaGrupo.SpacingBefore = 3;
                tablaGrupo.HorizontalAlignment = Element.ALIGN_LEFT;
                tablaGrupo.LockedWidth = true;
                ...
                PdfPCell _PdfPCell1 = new PdfPCell(new Phrase(i.Descripcion, _fontStylecliente));
                _PdfPCell1.Border = 0;
                ...
                tablaGrupo.AddCell(_PdfPCell1);

                PdfPCell _PdfPCell2 = new PdfPCell(new Phrase(i.ClaveGrupo, _fontStylecliente));
                _PdfPCell2.Border = 0;
                ...
                tablaGrupo.AddCell(_PdfPCell2);


                _documento.Add(tablaGrupo);
