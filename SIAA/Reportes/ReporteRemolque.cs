...
namespace SIAAPI.Reportes
{
    public class ReporteRemolque
    {
        ...
        #endregion
        public c_SubTipoRemContext  db = new c_SubTipoRemContext();
        public List<c_SubTipoRem> TipoRemolque = new List<c_SubTipoRem>();
...

        {
            ...
            HttpContext.Current.Response.AddHeader("content-disposition", "attachment; filename=\"ReporteRemolque.pdf" + "\"");
        ...
        private void ReportHeader()
        {
            ...
            paragraph.Add("Catalogo de Tipo Embalaje");
            ...
            float[] anchoColumnasencart = { 100f, 100f, 150f, 150f, 100f };
            ...
            _PdfPCell = new PdfPCell(new Phrase("ID", _fontStyleEncabezado));
            _PdfPCell.Border = 0;
            ...
            //_fontStyle = FontFactory.GetFont("Tahoma", 8f, COLORDEFUENTEREPORTE);
            _PdfPCell = new PdfPCell(new Phrase("Clave Remolque ", _fontStyleEncabezado));
            _PdfPCell.Border = 0;
            _PdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            _PdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _PdfPCell.BackgroundColor = COLORDEREPORTE;
            ...
            //_fontStyle = FontFactory.GetFont("Tahoma", 8f, COLORDEFUENTEREPORTE);
            _PdfPCell = new PdfPCell(new Phrase("Remolque o Semi", _fontStyleEncabezado));
            _PdfPCell.Border = 0;
            _PdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            _PdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _PdfPCell.BackgroundColor = COLORDEREPORTE;
            ...
            _PdfPCell = new PdfPCell(new Phrase("Fecha Final", _fontStyleEncabezado));
            _PdfPCell.Border = 0;
            _PdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            _PdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _PdfPCell.BackgroundColor = COLORDEREPORTE;
        ...
        private void ReportBody()
        {
            ...
            foreach (c_SubTipoRem b in TipoRemolque)
            {
                ...
                float[] anchoColumnasBancos = { 100f, 100f, 150f, 150f, 100f };
                ...
                PdfPCell _PdfPCell1 = new PdfPCell(new Phrase(b.IDTRemolque.ToString(), _fontStylecliente));
                _PdfPCell1.Border = 0;
                ...
                PdfPCell _PdfPCell2 = new PdfPCell(new Phrase(b.ClaveTipoRemolque, _fontStylecliente));
                _PdfPCell2.Border = 0;
                ...
                PdfPCell _PdfPCell4 = new PdfPCell(new Phrase(b.RemoSemi, _fontStylecliente));
                _PdfPCell4.Border = 0;
