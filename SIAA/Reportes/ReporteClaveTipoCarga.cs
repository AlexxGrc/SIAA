...
{
    public class ReporteClaveTipoCarga
    {
        ...
        #endregion
        public c_ClaveTipoCargaContext db = new c_ClaveTipoCargaContext();
        public List<c_ClaveTipoCarga> TipoCarga = new List<c_ClaveTipoCarga>();
        ...
        private void ReportHeader()
        {
            ...
            paragraph.Add("Catalogo Clave Tipo Carga");
            ...
            float[] anchoColumnasencart = { 100f, 200f, 150f, 150f };
        ...
        private void ReportBody()
        {
            ...
            foreach (c_ClaveTipoCarga b in TipoCarga)
            {
                ...
                float[] anchoColumnasBancos = { 100f, 200f, 150f, 150f };
                ...
                PdfPCell _PdfPCell1 = new PdfPCell(new Phrase(b.Clave.ToString(), _fontStylecliente)); ;
                _PdfPCell1.Border = 0;
