...
{
    public class InventarioPorAlmacenLev
    {
        #region Declaration
        ...
        public byte[] PrepareReport(int almacen, int familia)
        {
            ...
            HttpContext.Current.Response.AddHeader("content-disposition", "attachment; filename=\"ReporteLevantamientoInventario.pdf" + "\"");
        ...
        public List<ReporteInventarioArt> GetInvAlm(int idalmacen, int idfamilia)
        {
            ...
            try
            {
                if (idalmacen == 0 && idfamilia == 0)
                {
                    string cadena = "select * from ReporteInventarioArt order by IDAlmacen, IDFamilia, Cref";
                ...
                if (idalmacen == 0 && idfamilia !=0)
                {
                    string cadena = "select * from ReporteInventarioArt where IDFamilia = "+ idfamilia +" order by IDAlmacen, IDFamilia, Cref";
                    //"select I.IDInventarioAlmacen, I.IDAlmacen, C.ID as IDCaracteristica, C.Articulo_IDArticulo as IDArticulo, F.IDFamilia, I.Existencia, I.PorLlegar, I.Apartado, I.Disponibilidad from[dbo].[InventarioAlmacen] as I inner join (dbo.Caracteristica as C inner join(dbo.Articulo as A inner join dbo.Familia as F on A.IDFamilia = F.IDFamilia)on C.Articulo_IDArticulo = A.IDArticulo ) on I.IDCaracteristica = C.ID where F.IDFamilia = " + idfamilia + " order by IDAlmacen, IDFamilia";
                    inventario = db.Database.SqlQuery<ReporteInventarioArt>(cadena).ToList();
                }
                if (idalmacen !=0 && idfamilia == 0)
                {
                    string cadena = "select * from ReporteInventarioArt where IDAlmacen = "+ idalmacen+"  order by IDAlmacen, IDFamilia, Cref";
                    //"select I.IDInventarioAlmacen, I.IDAlmacen, C.ID as IDCaracteristica, C.Articulo_IDArticulo as IDArticulo, F.IDFamilia, I.Existencia, I.PorLlegar, I.Apartado, I.Disponibilidad from[dbo].[InventarioAlmacen] as I inner join (dbo.Caracteristica as C inner join(dbo.Articulo as A inner join dbo.Familia as F on A.IDFamilia = F.IDFamilia)on C.Articulo_IDArticulo = A.IDArticulo ) on I.IDCaracteristica = C.ID where I.IDAlmacen = " + idalmacen + " order by IDAlmacen, IDFamilia";
                    inventario = db.Database.SqlQuery<ReporteInventarioArt>(cadena).ToList();
                }
                if (idalmacen !=0 && idfamilia !=0)
                {
                    string cadena = " select * from ReporteInventarioArt  where IDAlmacen = " + idalmacen + " and IDFamilia= " + idfamilia + " order by IDAlmacen, IDFamilia, Cref";
        ...
        private void ReportHeader()
        {
            ...
            float[] anchoColumnasencabezado = { 100f, 50f, 350f, 100f };
             ...
             float[] anchoColumnasInvEnc = {70f, 170f,  224f, 48f, 40f, 40f };
            ...
            Font _fontStyleInvEnc = new Font(Font.FontFamily.TIMES_ROMAN, 7, Font.NORMAL | Font.UNDERLINE, BaseColor.WHITE);  // aqui podremos cambiar la fuente de LA FECHA y su tamanño
            ...
            PdfPCell _tablaInvEnc9 = new PdfPCell(new Phrase("Real", _fontStyleInvEnc));
            ...
            PdfPCell _tablaInvEnc10 = new PdfPCell(new Phrase("Diferencia", _fontStyleInvEnc));
            _tablaInvEnc10.Border = 0;
            _tablaInvEnc10.FixedHeight = 10f;
            _tablaInvEnc10.HorizontalAlignment = Element.ALIGN_LEFT;
            _tablaInvEnc10.VerticalAlignment = Element.ALIGN_MIDDLE;
            _tablaInvEnc10.BackgroundColor = BaseColor.DARK_GRAY;
            tablaInvEnc.AddCell(_tablaInvEnc10);
            _documento.Add(tablaInvEnc);
        ...
        private void ReportBody()
        {
            ...
            foreach (Almacen dato in alm)
            {
                ...
                Font _fontStyleAlmacen = new Font(Font.FontFamily.TIMES_ROMAN, 8, Font.BOLD);  // aqui podremos cambiar la fuente de LA FECHA y su tamanño
                ...
                foreach (Familia datof in fam)
                {
                    ...
                    Font _fontStyleFamilia = new Font(Font.FontFamily.TIMES_ROMAN, 8, Font.BOLD);  // aqui podremos cambiar la fuente de LA FECHA y su tamanño
                    ...
                    foreach (ReporteInventarioArt datoi in inv)
                    {
                        ...
                        float[] anchoColumnasInventario = { 70f, 170f, 224f, 48f, 40f, 40f };
                        ...
                        Font _fontStyleInventario = new Font(Font.FontFamily.TIMES_ROMAN, 8, Font.NORMAL);  // aqui podremos cambiar la fuente de LA FECHA y su tamanño
                        Font _fontStyleInventario1 = new Font(Font.FontFamily.TIMES_ROMAN, 8, Font.NORMAL);
                        PdfPCell _tablaInventario1 = new PdfPCell(new Phrase(_Cref, _fontStyleInventario));
                        _tablaInventario1.Border = 0;
                    
                        _tablaInventario1.HorizontalAlignment = Element.ALIGN_LEFT;
                        ...
                        PdfPCell _tablaInventario4 = new PdfPCell(new Phrase(_pres, new Font(Font.FontFamily.TIMES_ROMAN, 7, Font.NORMAL)));
                        _tablaInventario4.Border = 0;
                    //    _tablaInventario4.FixedHeight = 20f;
                        ...
                        PdfPCell _tablaInventario9 = new PdfPCell(new Phrase("______", _fontStyleInventario));
                        ...
                        PdfPCell _tablaInventario10 = new PdfPCell(new Phrase("______", _fontStyleInventario));
                        _tablaInventario10.Border = 0;
                        _tablaInventario10.FixedHeight = 10f;
                        _tablaInventario10.HorizontalAlignment = Element.ALIGN_LEFT;
                        _tablaInventario10.VerticalAlignment = Element.ALIGN_MIDDLE;
                        _tablaInventario10.BackgroundColor = BaseColor.WHITE;
                        tablaInventario.AddCell(_tablaInventario10);
                        _documento.Add(tablaInventario);
                    }
