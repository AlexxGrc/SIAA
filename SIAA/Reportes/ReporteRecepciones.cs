...
{
    public class ReporteRecepciones
    {
        #region Declaration
        ...
        List<EncRecepcion> Recepcions = new List<EncRecepcion>();
        #endregion
...

        {
            ...
            Recepcions = this.GetRecepciones();
            ...
            HttpContext.Current.Response.AddHeader("content-disposition", "attachment; filename=\"Recepciones.pdf" + "\"");
        ...
        public List<EncRecepcion> GetRecepciones()
        {
            List<EncRecepcion> recepcions = new List<EncRecepcion>();
            ...
            try
            {
                ...
                string cadena = "select *from EncRecepcion where fecha>='" + FI + "' and fecha <='" + FF + "' and status <>'Cancelado'";

                recepcions = db.Database.SqlQuery<EncRecepcion>(cadena).ToList();
            }
        ...
        private void ReportHeader()
        {
            ...
            _PdfPCell = new PdfPCell(new Phrase("Recepciones", _fontStyle));
            ...
            float[] anchoColumnasfactura = { 40f, 30f, 150f, 30f, 40f, 50f, 50f, 50f, 50f, 30f, 60f };

            PdfPTable tablae = new PdfPTable(anchoColumnasfactura);
            tablae.WidthPercentage = 100;
            tablae.HorizontalAlignment = Element.ALIGN_LEFT;
            ...
            _PdfPCell = new PdfPCell(new Phrase("No.Recepción", _fontStyle));
            _PdfPCell.Border = 0;
            _PdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
            _PdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _PdfPCell.BackgroundColor = colordefinido;
            ...
            //_fontStyle = FontFactory.GetFont("Tahoma", 8f, 1);
            _PdfPCell = new PdfPCell(new Phrase("Ticket", _fontStyle));
            _PdfPCell.Border = 0;
            _PdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
            _PdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _PdfPCell.BackgroundColor = colordefinido;
            ...
            //_fontStyle = FontFactory.GetFont("Tahoma", 8f, 1);
            _PdfPCell = new PdfPCell(new Phrase("Doc.Factura", _fontStyle));
            _PdfPCell.Border = 0;
            _PdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
            _PdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _PdfPCell.BackgroundColor = colordefinido;
            ...
            _PdfPCell = new PdfPCell(new Phrase("USUARIO", _fontStyle));
            _PdfPCell.Border = 0;
            _PdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
            _PdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _PdfPCell.BackgroundColor = colordefinido;
        ...
        private void ReportBody()
        {
            ...
            foreach (EncRecepcion fact in Recepcions)
            {
                ...
                Font _fontStyleparaestaFactura = new Font(Font.FontFamily.HELVETICA, 7, Font.NORMAL);  // aqui podremos cambiar la fuente de lcientes y su tamanño




                string fechapago = fact.Fecha.Year + "/" + fact.Fecha.Month + "/" + fact.Fecha.Day;
                ...
                PdfPCell _PdfPCell00pedido = new PdfPCell(new Phrase(fact.IDRecepcion.ToString(), _fontStyleparaestaFactura));
                ...
                Proveedor proveedor = new ProveedorContext().Proveedores.Find(fact.IDProveedor);
                PdfPCell _PdfPCell2pedido = new PdfPCell(new Phrase(proveedor.Empresa, _fontStyleparaestaFactura));
                ...
                PdfPCell _PdfPCell3pedido = new PdfPCell(new Phrase(fact.Ticket.ToString(), _fontStyleparaestaFactura));
                ...
                PdfPCell _PdfPCell6pedido = new PdfPCell(new Phrase(fact.DocumentoFactura, _fontStyleparaestaFactura));
                ...
                PdfPCell _PdfPCell7pedido = new PdfPCell(new Phrase(subtotal, _fontStyleparaestaFactura));
                ...
                PdfPCell _PdfPCell9pedido = new PdfPCell(new Phrase(total, _fontStyleparaestaFactura));
                ...
                PdfPCell _PdfPCell12pedido = new PdfPCell(new Phrase(fact.Status, _fontStyleparaestaFactura));
                ...
                PdfPCell _PdfPCell13pedido = new PdfPCell(new Phrase(fact.TipoCambio.ToString("C"), _fontStyleparaestaFactura));
                ...
                User u = usuario.Users.Find(fact.UserID);

                PdfPCell _PdfPCell13USUARIO = new PdfPCell(new Phrase(u.Username.ToString(), _fontStyleparaestaFactura));
                _PdfPCell13USUARIO.Border = 0;
                _PdfPCell13USUARIO.HorizontalAlignment = Element.ALIGN_RIGHT; // 
                _PdfPCell13USUARIO.VerticalAlignment = Element.ALIGN_MIDDLE;
                //_PdfPCell.BackgroundColor = BaseColor.YELLOW; // aqui no le vamos a poner colores
                tablaparaestafactura.AddCell(_PdfPCell13USUARIO);

                tablaparaestafactura.CompleteRow();

                c_Moneda moneda = new c_MonedaContext().c_Monedas.Find(fact.IDMoneda);

                if (moneda.ClaveMoneda == "USD")
                {
                    acumulasubtotalxUSD += fact.Total;
                }
                if (moneda.ClaveMoneda == "EUR")
                {
                    acumulasubtotalxEUR += fact.Total;
                }
                if (moneda.ClaveMoneda == "MXN")
                {
                    acumulasubtotalxMNX += fact.Total;
                }
    ...
    public class ITextEventsRecepcion : PdfPageEventHelper
    {
