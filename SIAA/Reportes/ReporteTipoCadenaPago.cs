...
{
    public class ReporteTipoCadenaPago
    {
        #region Declaration
        ...
        public List<c_TipoCadenaPago> tipoCadenaPago = new List<c_TipoCadenaPago>();
...

        {
            ...
            HttpContext.Current.Response.AddHeader("content-disposition", "attachment; filename=\"ReporteTipoCadenadePago.pdf" + "\"");
        ...
        private void ReportHeader()
        {
            ...
            paragraph.Add("Catalogo de Tipo Cadena de Pago");
            ...
            float[] anchoColumnasencart = { 300f, 300f };
        ...
        private void ReportBody()
        {
            ...
            foreach (c_TipoCadenaPago tp in tipoCadenaPago)
            {
                ...
                float[] anchoColumnasBancos = { 300f, 300f };

                // 50 para id 3000 para el nombre 100 para el telefono y 150 para el vendedor


                PdfPTable tablaCadenaPago = new PdfPTable(anchoColumnasBancos);
                //tablaProductosPrincipal.DefaultCell.Border = Rectangle.NO_BORDER;
               tablaCadenaPago.SetTotalWidth(anchoColumnasBancos);
               tablaCadenaPago.SpacingBefore = 3;
               tablaCadenaPago.HorizontalAlignment = Element.ALIGN_LEFT;
               tablaCadenaPago.LockedWidth = true;
                ...
                PdfPCell _PdfPCell1 = new PdfPCell(new Phrase(tp.Clave, _fontStylecliente));
                _PdfPCell1.Border = 0;
                ...
                tablaCadenaPago.AddCell(_PdfPCell1);

                PdfPCell _PdfPCell2 = new PdfPCell(new Phrase(tp.Descripcion, _fontStylecliente));
                _PdfPCell2.Border = 0;
                ...
                tablaCadenaPago.AddCell(_PdfPCell2);
                

                _documento.Add(tablaCadenaPago);
