...
namespace SIAAPI.Reportes
{
    ...
    public class Reportec_NumAutorizacionNaviero
    {
        ...
        #endregion
        public c_NumAutorizacionNavieroContext db = new c_NumAutorizacionNavieroContext();
        public List<c_NumAutorizacionNaviero> auto = new List<c_NumAutorizacionNaviero>();
...

        {
            ...
            HttpContext.Current.Response.AddHeader("content-disposition", "attachment; filename=\"ReporteNumAutorizacion.pdf" + "\"");
        ...
        private void ReportHeader()
        {
            ...
            paragraph.Add("Número de Autorización Naviero");
            ...
            float[] anchoColumnasencart = { 400f, 100f, 100f };
            ...
            _PdfPCell = new PdfPCell(new Phrase("NumAutorizado", _fontStyleEncabezado));
            _PdfPCell.Border = 0;
        ...
        private void ReportBody()
        {
            ...
            foreach (c_NumAutorizacionNaviero b in auto)
            {
                ...
                float[] anchoColumnasBancos = {  400f,100f, 100f };
                ...
                PdfPCell _PdfPCell1 = new PdfPCell(new Phrase(b.NumAutorizado, _fontStylecliente));
                _PdfPCell1.Border = 0;
