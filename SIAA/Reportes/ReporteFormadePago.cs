...
{
    public class ReporteFormadePago
    {



        public c_FormaPagoContext dfp = new c_FormaPagoContext();
        public List<c_FormaPago> Pago = new List<c_FormaPago>();
        ...
        #endregion
        public c_FormaPagoContext fp = new c_FormaPagoContext();
        public List<c_FormaPago> fdp = new List<c_FormaPago>();
        // aqui los puedes pasar como parametro al reporte
...

        {
            ...
            HttpContext.Current.Response.AddHeader("content-disposition", "attachment; filename=\"ReporteFormaPago.pdf" + "\"");
        ...
        private void ReportHeader()
        {
            ...
            p1.Leading = 20;
            p1.Add(new Phrase("Catalogo de Forma de Pago", new Font(Font.FontFamily.HELVETICA, 20, Font.BOLD)));
            p1.SpacingAfter = 40;
            _documento.Add(p1);
            ...
            float[] anchoColumnasencart = { 100f, 350f };
        ...
        private void ReportBody()
        {
            ...
            foreach (c_FormaPago b in Pago)
            {
                ...
                float[] anchoColumnasFormaPago = { 100f, 350f };

                // 50 para id 3000 para el nombre 100 para el telefono y 150 para el vendedor


                PdfPTable tablaFormaPago = new PdfPTable(anchoColumnasFormaPago);
                //tablaProductosPrincipal.DefaultCell.Border = Rectangle.NO_BORDER;
                tablaFormaPago.SetTotalWidth(anchoColumnasFormaPago);
                tablaFormaPago.SpacingBefore = 3;
                tablaFormaPago.HorizontalAlignment = Element.ALIGN_LEFT;
                tablaFormaPago.LockedWidth = true;
                ...
                PdfPCell _PdfPCell1 = new PdfPCell(new Phrase(b.ClaveFormaPago, _fontStylecliente));
                _PdfPCell1.Border = 0;
                ...
                tablaFormaPago.AddCell(_PdfPCell1);
                ...
                tablaFormaPago.AddCell(_PdfPCell4);
                tablaFormaPago.CompleteRow();
                _documento.Add(tablaFormaPago);
