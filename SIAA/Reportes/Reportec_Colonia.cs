...
namespace SIAAPI.Reportes
{
    public class Reportec_Colonia
    {
        ...
        #endregion
        public c_ColoniaContext db = new c_ColoniaContext();
        public List<c_Colonia> C = new List<c_Colonia>();
...

        {
            ...
            HttpContext.Current.Response.AddHeader("content-disposition", "attachment; filename=\"ReporteColonias.pdf" + "\"");
        ...
        private void ReportHeader()
        {
            ...
            _fontStyle = FontFactory.GetFont("Tahoma", 8f, COLORDEFUENTEREPORTE);
            _PdfPCell = new PdfPCell(new Phrase("Nombre del asentamiento", _fontStyleEncabezado));
            _PdfPCell.Border = 0;
            _PdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            _PdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _PdfPCell.BackgroundColor = COLORDEREPORTE;
        ...
        private void ReportBody()
        {
            ...
            foreach (c_Colonia b in C)
            {
                ...
                PdfPCell _PdfPCell1 = new PdfPCell(new Phrase(b.C_Colonia.ToString(), _fontStylecliente));
                _PdfPCell1.Border = 0;
                ...
                _PdfPCell = new PdfPCell(new Phrase(b.C_CodigoPostal.ToString(), _fontStyle));
                _PdfPCell.Border = 0;
                tablaBancos.AddCell(_PdfPCell);

                _fontStyle = FontFactory.GetFont("Tahoma", 10f, 1);
                _PdfPCell = new PdfPCell(new Phrase(b.NomAsentamiento, _fontStyle));
                _PdfPCell.Border = 0;
                tablaBancos.AddCell(_PdfPCell);
