...
{
    public class ReporteCondicionesPago
    {
        #region Declaration
        ...
        #endregion
        public CondicionesPagoContext db = new CondicionesPagoContext();
        public List<CondicionesPago> ConPago = new List<CondicionesPago>();
...

        {
            ...
            HttpContext.Current.Response.AddHeader("content-disposition", "attachment; filename=\"ReporteCondicionesPago.pdf" + "\"");
        ...
        private void ReportHeader()
        {
            ...
            p1.Leading = 20;
            p1.Add(new Phrase("Catalogo de Condiciones de Pago", new Font(Font.FontFamily.HELVETICA, 20, Font.BOLD)));
            p1.SpacingAfter = 40;
            _documento.Add(p1);
            ...
            //            float[] anchoColumnasencart = { 100f, 200f, 200f, 100f};
            float[] anchoColumnasencart = { 100f, 300f, 100f };
            ...
            Font _fontStyleEncabezado = FontFactory.GetFont("Tahoma", 13f, COLORDEFUENTEREPORTE);
                ...
                //_fontStyle = FontFactory.GetFont("Tahoma", 8f, COLORDEFUENTEREPORTE);
                _PdfPCell = new PdfPCell(new Phrase("Día de Crédito", _fontStyleEncabezado));
                _PdfPCell.Border = 0;
                _PdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
                _PdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
                _PdfPCell.BackgroundColor = COLORDEREPORTE;
        ...
        private void ReportBody()
        {
            ...
            //  
                ...
                foreach (CondicionesPago b in ConPago)
                {
                    ...
                    float[] anchoColumnasCondiPago= { 100f, 300f, 100f };

                    // 50 para id 3000 para el nombre 100 para el telefono y 150 para el vendedor


                    PdfPTable tablaCondiPago = new PdfPTable(anchoColumnasCondiPago);
                //tablaProductosPrincipal.DefaultCell.Border = Rectangle.NO_BORDER;
                tablaCondiPago.SetTotalWidth(anchoColumnasCondiPago);
                tablaCondiPago.SpacingBefore = 3;
                tablaCondiPago.HorizontalAlignment = Element.ALIGN_LEFT;
                tablaCondiPago.LockedWidth = true;
                    ...
                    PdfPCell _PdfPCell1 = new PdfPCell(new Phrase(b.ClaveCondicionesPago, _fontStylecliente));
                    _PdfPCell1.Border = 0;
                ...
                tablaCondiPago.AddCell(_PdfPCell1);
                ...
                tablaCondiPago.AddCell(_PdfPCell2);

                _fontStyle = FontFactory.GetFont("Tahoma", 10f, 1);
                _PdfPCell = new PdfPCell(new Phrase(b.DiasCredito.ToString(), _fontStyle));
                _PdfPCell.HorizontalAlignment = Element.ALIGN_RIGHT;
                _PdfPCell.VerticalAlignment = Element.ALIGN_CENTER;
                _PdfPCell.Border = 0;
                tablaCondiPago.AddCell(_PdfPCell);
                tablaCondiPago.CompleteRow();
                _documento.Add(tablaCondiPago);
