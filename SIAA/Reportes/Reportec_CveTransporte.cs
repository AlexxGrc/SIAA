...
{
    public class Reportec_CveTransporte
    {
        #region Declaration
        ...
        #endregion
        public c_CveTransporteContext db = new c_CveTransporteContext();
        public List<c_CveTransporte> CTrans = new List<c_CveTransporte>();
...

        {
            ...
            HttpContext.Current.Response.AddHeader("content-disposition", "attachment; filename=\"ReporteTransporte.pdf" + "\"");
        ...
        private void ReportHeader()
        {
            ...
            paragraph.Add("Clave Transporte");
            ...
            float[] anchoColumnasencart = { 100f, 200f, 100f, 100f,100f };
            ...
            _fontStyle = FontFactory.GetFont("Tahoma", 8f, COLORDEFUENTEREPORTE);
            _PdfPCell = new PdfPCell(new Phrase("Fecha Publicación", _fontStyleEncabezado));
            _PdfPCell.Border = 0;
            _PdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            _PdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _PdfPCell.BackgroundColor = COLORDEREPORTE;
        ...
        private void ReportBody()
        {
            ...
            foreach (c_CveTransporte b in CTrans)
            {
                ...
                float[] anchoColumnasBancos = { 100f, 200f, 100f, 100f, 100f };
                ...
                _fontStyle = FontFactory.GetFont("Tahoma", 10f, 1);
                _PdfPCell = new PdfPCell(new Phrase(b.Fpublicacion.ToString("dd/MM/yyyy"), _fontStyle));
                _PdfPCell.Border = 0;
                tablaBancos.AddCell(_PdfPCell);
