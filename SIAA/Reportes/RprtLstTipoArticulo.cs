...
{
    public class RprtLstTipoArticulo
    {
        //↓--variables
        Document documento;
        ...
        public List<TipoArticulo> ListaDatosBD_TipoArticulo = new List<TipoArticulo>();
        string titulo = "";
        ...
        {
            titulo = "REPORTE LISTA TIPOS DE ARTÍCULO";
            //↓--Logo desde BD
        ...
        {
            foreach (TipoArticulo BDTipoArticulo in ListaDatosBD_TipoArticulo)
            {
                ...
                celdaPdf = new PdfPCell(new Phrase(BDTipoArticulo.IDTipoArticulo.ToString(), fontCont));
                celdaPdf.Border = 0;
                celdaPdf.HorizontalAlignment = Element.ALIGN_LEFT;
                celdaPdf.VerticalAlignment = Element.ALIGN_MIDDLE;
                ...
                celdaPdf = new PdfPCell(new Phrase(BDTipoArticulo.Descripcion, fontCont));
                celdaPdf.Border = 0;
                celdaPdf.HorizontalAlignment = Element.ALIGN_LEFT;
                celdaPdf.VerticalAlignment = Element.ALIGN_MIDDLE;
                celdaPdf.BackgroundColor = BaseColor.WHITE;
