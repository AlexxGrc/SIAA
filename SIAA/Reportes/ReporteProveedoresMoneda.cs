...
{
    public class ReporteProveedoresMoneda
    {
        #region Declaration
        ...
        public byte[] PrepareReport(DateTime _fechaini, DateTime _fechafin, string _moneda, string _esta, string _nota)
        {
            ...
            HttpContext.Current.Response.AddHeader("content-disposition", "attachment; filename=\"ReporteProveedoresMoneda.pdf" + "\"");
        ...
        public List<ReportefenoProv> GetFacturas()
        {
            ...
            try
            {
                if (status == "T")
                {
                    ...
                    cadena = cadena + " where FechaPago>='" + fechaini.Year + "/" + fechaini.Month + "/" + fechaini.Day + " 00:00:01' and FechaPago <='" + fechafin.Year + "/" + fechafin.Month + "/" + fechafin.Day + " 23:59:59' and ClaveDivisa='" + ClaveDivisa + "'";
                ...
                {
                    string cadena = "select ID,FechaPago, SerieP, FolioP,  RFC,Empresa, ClaveFormaPago, Descripcion as FormaPago, ClaveDivisa, NoOperacion, Monto, RFCBancoEmisor, NombreBancoEmisor, CuentaEmisor, RFCBancoReceptor,NombreBancoReceptor, CuentaReceptor, IDTipoCadenaPago,Estado, UUID from VPagoFacturaProvT";
                    cadena = cadena + " where FechaPago>='" + fechaini.Year + "/" + fechaini.Month + "/" + fechaini.Day + " 00:00:01' and FechaPago <='" + fechafin.Year + "/" + fechafin.Month + "/" + fechafin.Day + " 23:59:59' and ClaveDivisa='" + ClaveDivisa + "' and Estado=1";
                    facturas = db.Database.SqlQuery<ReportefenoProv>(cadena).ToList();
                }
                if (status == "C")
                {
                    string cadena = "select ID,FechaPago, SerieP, FolioP,  RFC,Empresa, ClaveFormaPago, Descripcion as FormaPago, ClaveDivisa, NoOperacion, Monto, RFCBancoEmisor, NombreBancoEmisor, CuentaEmisor, RFCBancoReceptor,NombreBancoReceptor, CuentaReceptor, IDTipoCadenaPago,Estado, UUID from VPagoFacturaProvT";
                    cadena = cadena + " where FechaPago>='" + fechaini.Year + "/" + fechaini.Month + "/" + fechaini.Day + " 00:00:01' and FechaPago <='" + fechafin.Year + "/" + fechafin.Month + "/" + fechafin.Day + " 23:59:59' and ClaveDivisa='" + ClaveDivisa + "' and Estado=0";
                    facturas = db.Database.SqlQuery<ReportefenoProv>(cadena).ToList();
                }
            }
        ...
        private void ReportHeader()
        {
            ...
            _PdfPCell = new PdfPCell(new Phrase("Reporte Proveedores por Moneda", _fontStyle));
    ...
    public class ITextEventsRepLFacsPro : PdfPageEventHelper
    {
    ...
    public class fechasReporteFacsPro
    {
    ...
    public class ReporteFacturastsPro
    {
        [Key]
