...
namespace SIAAPI.Reportes
{
    public class GeneradorEtiqTin
    {
        ...
        List<Clslotetinta> lotes = new List<Clslotetinta>(); //Objeto que contendra la información del documento pdf
        int Recepcion { get; set; }



        public string nombreDocumento = string.Empty;
        public GeneradorEtiqTin(System.Drawing.Image logo, List<Clslotetinta> _lotes, int _Recepcion)
        {
            lotes = _lotes;
            ...
            _writer.PageEvent = new ITextEventsEtiqTinta(); // invoca la clase que esta mas abajo correspondiente al pie de pagina
        ...
        private void AgregaPropiedadesDocumento()
        {
            ...
            _documento.AddKeywords("Etiqueta TINTA");
            _documento.AddSubject("Etiqueta TINTA");
            _documento.AddTitle("Etiqueta TINTA");
        ...
        private void AgregarDatosProductos()
        {
            ...
            Articulo articulo;
            foreach (Clslotetinta lote in lotes)
            {
                ...
                p2.Add(new Phrase("\n" + lote.cantidad + " "  + lote.unidad, new Font(Font.FontFamily.HELVETICA, 14, Font.BOLD)));
                ...
                p3.Add(new Phrase("\nFactura " + lote.factura, new Font(Font.FontFamily.HELVETICA, 10)));
                p3.Add(new Phrase("\nAlmacen " + lote.ccodalm, new Font(Font.FontFamily.HELVETICA, 10)));
                ...
                PdfPCell celdacinta = new PdfPCell(new Phrase("No de envase\n" + lote.consecutivo, new Font(Font.FontFamily.TIMES_ROMAN, 24)));
        ...
        public class ITextEventsEtiqTinta : PdfPageEventHelper
        {
