...
using System.IO;
//using static SIAAPI.Reportes.ReporteActi;
using iTextSharp.text;
using iTextSharp.text.pdf;

namespace SIAAPI.Reportes
{
    public class Reportec_ClaveUnidadPeso
    {
        ...
        #endregion
        public c_ClaveUnidadPesoContext db = new c_ClaveUnidadPesoContext ();
        public List<c_ClaveUnidadPeso> ClaveUnidadPeso = new List<c_ClaveUnidadPeso>();
        ...
        private void ReportHeader()
        {
            ...
            paragraph.Add("Catalogo de Unidad Peso");
            ...
            _PdfPCell = new PdfPCell(new Phrase("Clave Unidad", _fontStyleEncabezado));
            _PdfPCell.Border = 0;
            ...
            //_fontStyle = FontFactory.GetFont("Tahoma", 8f, COLORDEFUENTEREPORTE);
            _PdfPCell = new PdfPCell(new Phrase("Nota", _fontStyleEncabezado));
            _PdfPCell.Border = 0;
            ...
            //_fontStyle = FontFactory.GetFont("Tahoma", 8f, COLORDEFUENTEREPORTE);
            _PdfPCell = new PdfPCell(new Phrase("Simbolo", _fontStyleEncabezado));
            _PdfPCell.Border = 0;
            _PdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            _PdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _PdfPCell.BackgroundColor = COLORDEREPORTE;
            ...
            //_fontStyle = FontFactory.GetFont("Tahoma", 8f, COLORDEFUENTEREPORTE);
            _PdfPCell = new PdfPCell(new Phrase("Bandera", _fontStyleEncabezado));
            _PdfPCell.Border = 0;
            _PdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            _PdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _PdfPCell.BackgroundColor = COLORDEREPORTE;
        ...
        private void ReportBody()
        {
            ...
            foreach (c_ClaveUnidadPeso b in ClaveUnidadPeso)
            {
                ...
                float[] anchoColumnasBancos = { 100f, 100f, 100f, 100f, 100f,100f };
                ...
                tablaBancos.HorizontalAlignment = Element.ALIGN_CENTER;
                ...
                PdfPCell _PdfPCell1 = new PdfPCell(new Phrase(b.ClaveUnidad, _fontStylecliente));
                _PdfPCell1.Border = 0;
                ...
                PdfPCell _PdfPCell2 = new PdfPCell(new Phrase(b.Nombre, _fontStylecliente));
                _PdfPCell2.Border = 0;
                ...
                _PdfPCell = new PdfPCell(new Phrase(b.Nota, _fontStyle));
                _PdfPCell.Border = 0;
                ...
                //_fontStyle = FontFactory.GetFont("Tahoma", 10f, 1);
                //_PdfPCell = new PdfPCell(new Phrase(b.FIVigencia.ToString("dd/MM/yyyy"), _fontStyle));
                //_PdfPCell.Border = 0;
                //_PdfPCell4.HorizontalAlignment = Element.ALIGN_CENTER;
                //_PdfPCell4.VerticalAlignment = Element.ALIGN_MIDDLE;
                //_PdfPCell4.BackgroundColor = BaseColor.WHITE;
                ...
                //if (b.FFVigencia == null)
                //{
                //    _PdfPCell = new PdfPCell(new Phrase("", _fontStyle));
                //}
                //else
                //{
                //    _PdfPCell = new PdfPCell(new Phrase(b.FFVigencia?.ToString("dd/MM/yyyy"), _fontStyle));
                //}
                //_fontStyle = FontFactory.GetFont("Tahoma", 10f, 1);
                //_PdfPCell.Border = 0;
                //tablaBancos.AddCell(_PdfPCell);
                ...
                _fontStyle = FontFactory.GetFont("Tahoma", 10f, 1);
                _PdfPCell = new PdfPCell(new Phrase(b.Simbolo, _fontStyle));
                _PdfPCell.Border = 0;
                _PdfPCell4.HorizontalAlignment = Element.ALIGN_CENTER;
                _PdfPCell4.VerticalAlignment = Element.ALIGN_MIDDLE;
                _PdfPCell4.BackgroundColor = BaseColor.WHITE;
                ...
                _fontStyle = FontFactory.GetFont("Tahoma", 10f, 1);
                _PdfPCell = new PdfPCell(new Phrase(b.Bandera, _fontStyle));
                _PdfPCell.Border = 0;
                _PdfPCell4.HorizontalAlignment = Element.ALIGN_CENTER;
                _PdfPCell4.VerticalAlignment = Element.ALIGN_MIDDLE;
                _PdfPCell4.BackgroundColor = BaseColor.WHITE;
