...
{
    public class ReporteCodigoTransporteAereo
    {
        #region Declaration
        ...
        #endregion
        public c_CodigoTransporteAereoContext db = new c_CodigoTransporteAereoContext();
        public List<c_CodigoTransporteAereo> TransAereo = new List<c_CodigoTransporteAereo>();
        ...
        private void ReportHeader()
        {
            ...
            paragraph.Add("Listado Transporte Aéreo");
            ...
            float[] anchoColumnasencart = { 40f, 100f, 160f, 100f, 100f, 100f };
            ...
            _fontStyle = FontFactory.GetFont("Tahoma", 8f, COLORDEFUENTEREPORTE);
            _PdfPCell = new PdfPCell(new Phrase("Nacionalidad", _fontStyleEncabezado));
            _PdfPCell.Border = 0;
            _PdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            _PdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _PdfPCell.BackgroundColor = COLORDEREPORTE;
            ...
            _fontStyle = FontFactory.GetFont("Tahoma", 8f, COLORDEFUENTEREPORTE);
            _PdfPCell = new PdfPCell(new Phrase("Aerolínea", _fontStyleEncabezado));
            _PdfPCell.Border = 0;
            _PdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            _PdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _PdfPCell.BackgroundColor = COLORDEREPORTE;
            ...
            _fontStyle = FontFactory.GetFont("Tahoma", 8f, COLORDEFUENTEREPORTE);
            _PdfPCell = new PdfPCell(new Phrase("Designador", _fontStyleEncabezado));
            _PdfPCell.Border = 0;
            _PdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            _PdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _PdfPCell.BackgroundColor = COLORDEREPORTE;
            ...
            _PdfPCell = new PdfPCell(new Phrase("Fecha Inicio Vigencia", _fontStyleEncabezado));
            _PdfPCell.Border = 0;
            _PdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            _PdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _PdfPCell.BackgroundColor = COLORDEREPORTE;
            ...
            _PdfPCell = new PdfPCell(new Phrase("Fecha Final Vigencia", _fontStyleEncabezado));
            _PdfPCell.Border = 0;
            _PdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            _PdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _PdfPCell.BackgroundColor = COLORDEREPORTE;
        ...
        private void ReportBody()
        {
            ...
            foreach (c_CodigoTransporteAereo b in TransAereo)
            {
                ...
                float[] anchoColumnasBancos = { 40f, 100f, 160f, 100f, 100f, 100f };
                ...
                PdfPCell _PdfPCell4 = new PdfPCell(new Phrase(b.Nacionalidad, _fontStylecliente));
                _PdfPCell4.Border = 0;
                ...
                _PdfPCell = new PdfPCell(new Phrase(b.Aerolinea, _fontStyle));
                _PdfPCell.Border = 0;
                tablaBancos.AddCell(_PdfPCell);

                _fontStyle = FontFactory.GetFont("Tahoma", 10f, 1);
                _PdfPCell = new PdfPCell(new Phrase(b.Designador, _fontStyle));
                _PdfPCell.Border = 0;
                tablaBancos.AddCell(_PdfPCell);
