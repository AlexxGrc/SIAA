...
{
    public class Reportec_ContenedorMaritimo
    {
        #region Declaration
        ...
        #endregion
        public c_ContenedorMaritimoContext db = new c_ContenedorMaritimoContext();
        public List<c_ContenedorMaritimo> ConM = new List<c_ContenedorMaritimo>();
...

        {
            ...
            HttpContext.Current.Response.AddHeader("content-disposition", "attachment; filename=\"ReporteContenedorMaritimo.pdf" + "\"");
        ...
        private void ReportHeader()
        {
            ...
            paragraph.Add("Listado Contenedor Marítimo");
            ...
            //_fontStyle = FontFactory.GetFont("Tahoma", 8f, COLORDEFUENTEREPORTE);
            _PdfPCell = new PdfPCell(new Phrase("Descripcion", _fontStyleEncabezado));
            _PdfPCell.Border = 0;
            _PdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            _PdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _PdfPCell.BackgroundColor = COLORDEREPORTE;
        ...
        private void ReportBody()
        {
            ...
            foreach (c_ContenedorMaritimo b in ConM)
            {
                ...
                float[] anchoColumnasBancos = { 100f, 200f, 200f, 100f };
                ...
                PdfPCell _PdfPCell1 = new PdfPCell(new Phrase(b.ClaveContenedor, _fontStylecliente));
                _PdfPCell1.Border = 0;
