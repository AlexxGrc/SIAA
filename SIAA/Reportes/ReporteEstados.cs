...
namespace SIAAPI.Reportes
{
    public class ReporteEstados
    {
        ...
        #endregion
        public VEstadoContext db = new VEstadoContext();
        public List<VEstado> estados = new List<VEstado>();
...

        {
            ...
            HttpContext.Current.Response.AddHeader("content-disposition", "attachment; filename=\"ReporteEstados.pdf" + "\"");
        ...
        private void ReportHeader()
        {
            ...
            //Asi se queda
            float[] anchoColumna1 = { 150f, 450f };
            PdfPTable tabla1 = new PdfPTable(anchoColumna1);

            tabla1.SetTotalWidth(anchoColumna1);
            tabla1.SpacingBefore = 0;
            tabla1.DefaultCell.Border = Rectangle.NO_BORDER;
            tabla1.HorizontalAlignment = Element.ALIGN_LEFT;
            tabla1.LockedWidth = true;
            Font _fontStyleencabezado1 = new Font(Font.FontFamily.TIMES_ROMAN, 9, Font.BOLD);
            ...
            p1.IndentationLeft = 200f;
            p1.Leading = 20;
            p1.Add(new Phrase("Catalogo de Estados", new Font(Font.FontFamily.HELVETICA, 20, Font.BOLD)));
            p1.SpacingAfter = 40;
            _documento.Add(p1);
            ...
            Font _fontStyleEncabezado = FontFactory.GetFont("Tahoma", 13f, COLORDEFUENTEREPORTE);
                ...
                _PdfPCell = new PdfPCell(new Phrase("País", _fontStyleEncabezado));
                _PdfPCell.Border = 0;
            ...
            _PdfPCell = new PdfPCell(new Phrase("Clave Estado", _fontStyleEncabezado));
            _PdfPCell.Border = 0;
            _PdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
            _PdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _PdfPCell.BackgroundColor = COLORDEREPORTE;
            ...
            //_fontStyle = FontFactory.GetFont("Tahoma", 8f, COLORDEFUENTEREPORTE);
            _PdfPCell = new PdfPCell(new Phrase("Estados", _fontStyleEncabezado));
                _PdfPCell.Border = 0;
                _PdfPCell.HorizontalAlignment = Element.ALIGN_CENTER;
                _PdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
                _PdfPCell.BackgroundColor = COLORDEREPORTE;
        ...
        private void ReportBody()
        {
            ...
            //  
                ...
                foreach (VEstado b in estados)
                {
                    ...
                    float[] anchoColumnasestados= { 200f, 200f,200f };

                    // 50 para id 3000 para el nombre 100 para el telefono y 150 para el vendedor

                    PdfPTable tablatipoCon = new PdfPTable(anchoColumnasestados);
                //tablaProductosPrincipal.DefaultCell.Border = Rectangle.NO_BORDER;
                tablatipoCon.SetTotalWidth(anchoColumnasestados);
                tablatipoCon.SpacingBefore = 3;
                tablatipoCon.HorizontalAlignment = Element.ALIGN_LEFT;
                tablatipoCon.LockedWidth = true;
                    ...
                    PdfPCell _PdfPCell1 = new PdfPCell(new Phrase(b.Pais, _fontStylecliente));
                    _PdfPCell1.Border = 0;
                ...
                tablatipoCon.AddCell(_PdfPCell1);


                PdfPCell _PdfPCell2 = new PdfPCell(new Phrase(b.c_Estado, _fontStylecliente));
                _PdfPCell2.Border = 0;
                _PdfPCell2.HorizontalAlignment = Element.ALIGN_CENTER;
                _PdfPCell2.VerticalAlignment = Element.ALIGN_CENTER;
                _PdfPCell2.BackgroundColor = BaseColor.WHITE;
                tablatipoCon.AddCell(_PdfPCell2);

                PdfPCell _PdfPCell3 = new PdfPCell(new Phrase(b.Estado, _fontStylecliente));
                    _PdfPCell3.Border = 0;
                    _PdfPCell3.HorizontalAlignment = Element.ALIGN_LEFT;
                    _PdfPCell3.VerticalAlignment = Element.ALIGN_CENTER;
                    _PdfPCell3.BackgroundColor = BaseColor.WHITE;
                tablatipoCon.AddCell(_PdfPCell3);

                _documento.Add(tablatipoCon);
