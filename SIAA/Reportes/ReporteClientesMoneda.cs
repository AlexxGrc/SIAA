...
namespace SIAAPI.Reportes
{
    ...
    public class ReporteClientesMoneda
    {
        ...
        public byte[] PrepareReport(DateTime _fechaini, DateTime _fechafin, string _moneda, string _esta, string _nota)
        {
            fechaini = _fechaini;
            fechafin = _fechafin;
            ...
            HttpContext.Current.Response.AddHeader("content-disposition", "attachment; filename=\"ReporteClientesMoneda.pdf" + "\"");
        ...
        public List<ReportefenoClie> GetFacturas()
        {
            List<ReportefenoClie> facturas = new List<ReportefenoClie>();
            ...
            try
            {
                if (status == "T")
                {
                    ...
                    cadena = cadena + " where FechaPago>='" + FI + " 00:00:01' and FechaPago <='" + FF + " 23:59:59'";
                    if (ClaveDivisa != "0")
                    {
                        cadena = cadena + " and ClaveDivisa='" + ClaveDivisa + "'";
                    }
                ...
                {
                    string cadena = "select IDPagoFactura, FechaPago, IDCliente, Nombre, ClaveFormaPago, Descripcion, ClaveDivisa, TC, NoOperacion, Monto, RFCBancoEmisor,NombreBancoEmisor CuentaEmisor, RFCBancoReceptor, CuentaReceptor,  Clave as ClaveCadenaPago, TipoCadenaPago, CertificadoPago, IDTipoCadenaPago, SelloPago, Observacion, Estado from [dbo].[VPagoFacturaC]";
                    cadena = cadena + " where FechaPago>='" + FI + " 00:00:01' and FechaPago <='" + FF + " 23:59:59' and Estado=1";
                    if (ClaveDivisa != "0")
                    {
                        cadena = cadena + "and ClaveDivisa='" + ClaveDivisa + "'";
                    }
                ...
                {
                    string cadena = "select IDPagoFactura, FechaPago, IDCliente, Nombre, ClaveFormaPago, Descripcion, ClaveDivisa, TC, NoOperacion, Monto, RFCBancoEmisor,NombreBancoEmisor CuentaEmisor, RFCBancoReceptor, CuentaReceptor,  Clave as ClaveCadenaPago, TipoCadenaPago, CertificadoPago, IDTipoCadenaPago, SelloPago, Observacion, Estado from [dbo].[VPagoFacturaC]";
                    cadena = cadena + " where FechaPago>='" + FI + " 00:00:01' and FechaPago <='" + FF + " 23:59:59' and Estado=0";
                    if (ClaveDivisa != "0")
                    {
                        cadena = cadena + " and ClaveDivisa='" + ClaveDivisa + "'";
                    }
        ...
        private void ReportHeader()
        {
            ...
            _PdfPCell = new PdfPCell(new Phrase("Reporte por Moneda", _fontStyle));
        ...
        private void ReportBody()
        {
            ...
            foreach (ReportefenoClie fact in facturas)
            {
                // Cuerpo del reporte
                //tring moneda = new c_MonedaContext().c_Monedas.Find(fact.IDMoneda).Descripcion;
    ...
    public class ITextEventsRepLFacss : PdfPageEventHelper
    {
    ...
    public class fechasReporteFacss
    {
    ...
    public class ReporteFacturasts
    {
        [Key]
