...
namespace SIAAPI.Reportes
{
    public class ReporteporFecha
    {
        ...
        public byte[] PrepareReport(DateTime _fechaini, DateTime _fechafin, int _idCliente, string _esta, string _nota)
        {
            fechaini = _fechaini;
            fechafin = _fechafin;
            ...
            HttpContext.Current.Response.AddHeader("content-disposition", "attachment; filename=\"ListadoPorFechaClientes.pdf" + "\"");
        ...
        private void ReportHeader()
        {
            ...
            _PdfPCell = new PdfPCell(new Phrase("Reporte por Fecha", _fontStyle));
    ...
    public class ITextEventsRepLFacClies : PdfPageEventHelper
    {
    ...
    public class fechasReporteFacClies
    {
    ...
    public class ReporteFacturasClies
    {
        [Key]
