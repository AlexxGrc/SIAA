...
{
    public class ReporteTipoEstacion
    {
        ...
        #endregion
        public c_TipoEstacionContext db = new c_TipoEstacionContext();
        public List<c_TipoEstacion> TipoEstacion = new List<c_TipoEstacion>();
        ...
        private void ReportHeader()
        {
            ...
            paragraph.Add("Catalogo de Tipo Estación");
            ...
            float[] anchoColumnasencart = { 100f, 150f, 150f, 100f, 100f};
            ...
            _PdfPCell = new PdfPCell(new Phrase("Clave Estacion", _fontStyleEncabezado));
            _PdfPCell.Border = 0;
            ...
            _fontStyle = FontFactory.GetFont("Tahoma", 8f, COLORDEFUENTEREPORTE);
            _PdfPCell = new PdfPCell(new Phrase("Descripción Estación", _fontStyleEncabezado));
            _PdfPCell.Border = 0;
            _PdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            _PdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _PdfPCell.BackgroundColor = COLORDEREPORTE;
            ...
            _fontStyle = FontFactory.GetFont("Tahoma", 8f, COLORDEFUENTEREPORTE);
            _PdfPCell = new PdfPCell(new Phrase("Clave Transporte", _fontStyleEncabezado));
            _PdfPCell.Border = 0;
            _PdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            _PdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _PdfPCell.BackgroundColor = COLORDEREPORTE;
            ...
            _fontStyle = FontFactory.GetFont("Tahoma", 8f, COLORDEFUENTEREPORTE);
            _PdfPCell = new PdfPCell(new Phrase("FIVigencia", _fontStyleEncabezado));
            _PdfPCell.Border = 0;
            _PdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            _PdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _PdfPCell.BackgroundColor = COLORDEREPORTE;
            ...
            _fontStyle = FontFactory.GetFont("Tahoma", 8f, COLORDEFUENTEREPORTE);
            _PdfPCell = new PdfPCell(new Phrase("FFVigencia", _fontStyleEncabezado));
            _PdfPCell.Border = 0;
            _PdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            _PdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _PdfPCell.BackgroundColor = COLORDEREPORTE;
        ...
        private void ReportBody()
        {
            ...
            foreach (c_TipoEstacion b in TipoEstacion)
            {
                ...
                float[] anchoColumnasBancos = { 100f, 150f, 150f, 100f, 100f };
                ...
                PdfPCell _PdfPCell1 = new PdfPCell(new Phrase(b.ClaveEstacion.ToString(), _fontStylecliente)); ;
                _PdfPCell1.Border = 0;
                ...
                PdfPCell _PdfPCell4 = new PdfPCell(new Phrase(b.DescripcionEstacion, _fontStylecliente));
                _PdfPCell4.Border = 0;
                ...
                _PdfPCell = new PdfPCell(new Phrase(b.ClaveTransporte, _fontStyle));
                _PdfPCell.Border = 0;
