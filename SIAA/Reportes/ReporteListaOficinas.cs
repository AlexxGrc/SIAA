...
{
    public class ReporteListaOficinas
    {
        //↓--variables
        Document documento;
        ...
        public List<Oficina> ListaDatosBD_Oficina = new List<Oficina>();
        string titulo = "";
        ...
        {
            titulo = "REPORTE LISTA DE OFICINAS";
            //↓--Logo desde BD
            ...
            float[] anchoColEncCont = { 80f, 230f, 60f, 230f };//ancho de las columas del encabezado de tabla de contenido
            ...
            celdaPdf = new PdfPCell(new Phrase("Oficina", fontEncCont));
            celdaPdf.Border = 0;
            ...
            celdaPdf = new PdfPCell(new Phrase("Responsable", fontEncCont));
            celdaPdf.Border = 0;
            celdaPdf.HorizontalAlignment = Element.ALIGN_LEFT;
            celdaPdf.VerticalAlignment = Element.ALIGN_MIDDLE;
            celdaPdf.BackgroundColor = COLORDEREPORTE;
            ...
            celdaPdf = new PdfPCell(new Phrase("Teléfono", fontEncCont));
            celdaPdf.Border = 0;
            celdaPdf.HorizontalAlignment = Element.ALIGN_LEFT;
            celdaPdf.VerticalAlignment = Element.ALIGN_MIDDLE;
            celdaPdf.BackgroundColor = COLORDEREPORTE;
            ...
            celdaPdf = new PdfPCell(new Phrase("Extensión", fontEncCont));
            celdaPdf.Border = 0;
            celdaPdf.HorizontalAlignment = Element.ALIGN_LEFT;
            celdaPdf.VerticalAlignment = Element.ALIGN_MIDDLE;
            celdaPdf.BackgroundColor = COLORDEREPORTE;
        ...
        {
            foreach (Oficina BDOficina in ListaDatosBD_Oficina)
            {
                //↓--Creacion de tabla para contenido de tabla
                float[] anchoColCont = { 80f, 230f, 60f, 230f };
                ...
                celdaPdf = new PdfPCell(new Phrase(BDOficina.NombreOficina, fontCont));
                celdaPdf.Border = 0;
                celdaPdf.HorizontalAlignment = Element.ALIGN_LEFT;
                celdaPdf.VerticalAlignment = Element.ALIGN_MIDDLE;
                ...
                celdaPdf = new PdfPCell(new Phrase(BDOficina.Responsable, fontCont));
                celdaPdf.Border = 0;
                celdaPdf.HorizontalAlignment = Element.ALIGN_LEFT;
                celdaPdf.VerticalAlignment = Element.ALIGN_MIDDLE;
                celdaPdf.BackgroundColor = BaseColor.WHITE;
                ...
                celdaPdf = new PdfPCell(new Phrase(BDOficina.Telefono, fontCont));
                celdaPdf.Border = 0;
                celdaPdf.HorizontalAlignment = Element.ALIGN_LEFT;
                celdaPdf.VerticalAlignment = Element.ALIGN_MIDDLE;
                celdaPdf.BackgroundColor = BaseColor.WHITE;
                ...
                celdaPdf = new PdfPCell(new Phrase(BDOficina.Extension.ToString(), fontCont));
                celdaPdf.Border = 0;
                celdaPdf.HorizontalAlignment = Element.ALIGN_LEFT;
                celdaPdf.VerticalAlignment = Element.ALIGN_MIDDLE;
                celdaPdf.BackgroundColor = BaseColor.WHITE;
