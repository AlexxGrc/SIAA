...
{
    public class Rprt_CierreVentas
    {
        //↓--variables
        Document documento;
        ...
        public List<CierreVentas> ListaDatosBD_CierreVentas = new List<CierreVentas>();
        ...
        {
            titulo = "REPORTE DEL CIERRE DE VENTAS";
            //↓--Logo desde BD
            ...
            float[] anchoColEncCont = { 60f, 60f, 60f, 60f, 60f, 60f, 60f, 60f, 60f, 60f };//ancho de las columas del encabezado de tabla de contenido
        ...
        {
            foreach (CierreVentas BDCierreVentas in ListaDatosBD_CierreVentas)
            {
                CierreVentasContext db = new SIAAPI.Models.Comisiones.CierreVentasContext();
                ClsDatoString vendedores = db.Database.SqlQuery<ClsDatoString>("select Nombre as Dato from Vendedor where IDVendedor = " + BDCierreVentas.IDVendedor).ToList()[0];
                ClsDatoString monedas = db.Database.SqlQuery<ClsDatoString>("select ClaveMoneda as Dato from c_Moneda where IDMoneda = " + BDCierreVentas.IDMonedaCA).ToList()[0];
                ClsDatoString meses = db.Database.SqlQuery<ClsDatoString>("select Mes as Dato from c_Meses where IDMes = " + BDCierreVentas.IDMes).ToList()[0];

                //↓--Creacion de tabla para contenido de tabla
                float[] anchoColCont = { 60f, 60f, 60f, 60f, 60f, 60f, 60f, 60f, 60f, 60f };
                ...
                celdaPdf = new PdfPCell(new Phrase(meses.Dato, fontCont));
                celdaPdf.Border = 0;
                celdaPdf.HorizontalAlignment = Element.ALIGN_LEFT;
                celdaPdf.VerticalAlignment = Element.ALIGN_MIDDLE;
                ...
                celdaPdf = new PdfPCell(new Phrase(BDCierreVentas.Ano.ToString(), fontCont));
                celdaPdf.Border = 0;
                celdaPdf.HorizontalAlignment = Element.ALIGN_LEFT;
                celdaPdf.VerticalAlignment = Element.ALIGN_MIDDLE;
                celdaPdf.BackgroundColor = BaseColor.WHITE;
                ...
                celdaPdf = new PdfPCell(new Phrase(BDCierreVentas.NumPedidos.ToString(), fontCont));
                celdaPdf.Border = 0;
                celdaPdf.HorizontalAlignment = Element.ALIGN_LEFT;
                celdaPdf.VerticalAlignment = Element.ALIGN_MIDDLE;
                celdaPdf.BackgroundColor = BaseColor.WHITE;
                ...
                celdaPdf = new PdfPCell(new Phrase(BDCierreVentas.VentasMXN.ToString("C"), fontCont));
                celdaPdf.Border = 0;
                celdaPdf.HorizontalAlignment = Element.ALIGN_LEFT;
                celdaPdf.VerticalAlignment = Element.ALIGN_MIDDLE;
                celdaPdf.BackgroundColor = BaseColor.WHITE;
                ...
                celdaPdf = new PdfPCell(new Phrase(BDCierreVentas.VentasUSD.ToString("C"), fontCont));
                celdaPdf.Border = 0;
                celdaPdf.HorizontalAlignment = Element.ALIGN_LEFT;
                celdaPdf.VerticalAlignment = Element.ALIGN_MIDDLE;
                celdaPdf.BackgroundColor = BaseColor.WHITE;
                ...
                celdaPdf = new PdfPCell(new Phrase(BDCierreVentas.Cuota.ToString("C"), fontCont));
                celdaPdf.Border = 0;
                celdaPdf.HorizontalAlignment = Element.ALIGN_LEFT;
                celdaPdf.VerticalAlignment = Element.ALIGN_MIDDLE;
                celdaPdf.BackgroundColor = BaseColor.WHITE;
                ...
                celdaPdf = new PdfPCell(new Phrase(BDCierreVentas.CuotaAlcanzada.ToString("C"), fontCont));
                celdaPdf.Border = 0;
                celdaPdf.HorizontalAlignment = Element.ALIGN_LEFT;
                celdaPdf.VerticalAlignment = Element.ALIGN_MIDDLE;
                celdaPdf.BackgroundColor = BaseColor.WHITE;
                ...
                celdaPdf = new PdfPCell(new Phrase(monedas.Dato, fontCont));
                celdaPdf.Border = 0;
                celdaPdf.HorizontalAlignment = Element.ALIGN_LEFT;
                celdaPdf.VerticalAlignment = Element.ALIGN_MIDDLE;
                celdaPdf.BackgroundColor = BaseColor.WHITE;
                ...
                celdaPdf = new PdfPCell(new Phrase(BDCierreVentas.Comision.ToString(), fontCont));
                celdaPdf.Border = 0;
                celdaPdf.HorizontalAlignment = Element.ALIGN_LEFT;
                celdaPdf.VerticalAlignment = Element.ALIGN_MIDDLE;
                celdaPdf.BackgroundColor = BaseColor.WHITE;
