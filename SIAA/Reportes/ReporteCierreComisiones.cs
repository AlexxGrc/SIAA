...
{
    public class ReporteCierreComisiones
    {
        #region Declaration
 ...
 idmes = _IDMes;
            ...
            HttpContext.Current.Response.AddHeader("content-disposition", "attachment; filename=\"ReporteCierreComisiones.pdf" + "\"");
        ...
        public List<VComisionVendedor> GetCierrecom(int idmes, int anio)
        {
            if (anio == 0 || idmes == 0)
            {
            ...
            try
            {
                ...
                string cadenaCV = "select * from dbo.VComisionVendedor where mescom = " + idmes + " and Aniocom= " + anio + "";
...
//se modifico de aquí
            ...
            paragraph.Add("Reporte Cierre Comisiones");
...
//Aquí termina la modificación del encabezado
            ...
            float[] anchoColumnasencart = { 20f, 20f, 40f, 40f, 20f, 20f, 40f, 40f, 40f, 20f, 20f, 20f, 50f, 20f, 20f, 50f, 50f, 20f, 20f, 30f };
            ...
            Font _fontStyleEncabezado = FontFactory.GetFont("Tahoma", 7f, COLORDEFUENTEREPORTE);
        

            //_fontStyle = FontFactory.GetFont("Tahoma", 8f, COLORDEFUENTEREPORTE);
            _PdfPCell = new PdfPCell(new Phrase("Fecha Factura", _fontStyleEncabezado));
            _PdfPCell.Border = 0;
            ...
            //_fontStyle = FontFactory.GetFont("Tahoma", 8f, COLORDEFUENTEREPORTE);
            _PdfPCell = new PdfPCell(new Phrase("Fecha Pedido", _fontStyleEncabezado));
            _PdfPCell.Border = 0;
            _PdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            _PdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _PdfPCell.BackgroundColor = COLORDEREPORTE;
            ...
            //_fontStyle = FontFactory.GetFont("Tahoma", 8f, COLORDEFUENTEREPORTE);
            _PdfPCell = new PdfPCell(new Phrase("Serie", _fontStyleEncabezado));
            _PdfPCell.Border = 0;
            _PdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            _PdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _PdfPCell.BackgroundColor = COLORDEREPORTE;
            ...
            //_fontStyle = FontFactory.GetFont("Tahoma", 8f, COLORDEFUENTEREPORTE);
            _PdfPCell = new PdfPCell(new Phrase("No. Factura", _fontStyleEncabezado));
            _PdfPCell.Border = 0;
            _PdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            _PdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _PdfPCell.BackgroundColor = COLORDEREPORTE;
            ...
            //_fontStyle = FontFactory.GetFont("Tahoma", 8f, COLORDEFUENTEREPORTE);
            _PdfPCell = new PdfPCell(new Phrase("Subtotal", _fontStyleEncabezado));
            _PdfPCell.Border = 0;
            _PdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            _PdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _PdfPCell.BackgroundColor = COLORDEREPORTE;
            ...
            //_fontStyle = FontFactory.GetFont("Tahoma", 8f, COLORDEFUENTEREPORTE);
            _PdfPCell = new PdfPCell(new Phrase("Rentabilidad", _fontStyleEncabezado));
            _PdfPCell.Border = 0;
            _PdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            _PdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _PdfPCell.BackgroundColor = COLORDEREPORTE;
            ...
            //_fontStyle = FontFactory.GetFont("Tahoma", 8f, COLORDEFUENTEREPORTE);
            _PdfPCell = new PdfPCell(new Phrase("Penalizaciones",  _fontStyleEncabezado));
            _PdfPCell.Border = 0;
            _PdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            _PdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _PdfPCell.BackgroundColor = COLORDEREPORTE;
            ...
            _PdfPCell = new PdfPCell(new Phrase("Tipo", _fontStyleEncabezado));
            _PdfPCell.Border = 0;
            _PdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            _PdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _PdfPCell.BackgroundColor = COLORDEREPORTE;
            tablae.AddCell(_PdfPCell);
            _PdfPCell = new PdfPCell(new Phrase("Pagada", _fontStyleEncabezado));
            _PdfPCell.Border = 0;
            _PdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            _PdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _PdfPCell.BackgroundColor = COLORDEREPORTE;
            tablae.AddCell(_PdfPCell);
            _PdfPCell = new PdfPCell(new Phrase("Costo", _fontStyleEncabezado));
            _PdfPCell.Border = 0;
            _PdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            _PdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _PdfPCell.BackgroundColor = COLORDEREPORTE;
            tablae.AddCell(_PdfPCell);
            _PdfPCell = new PdfPCell(new Phrase("Moneda Factura", _fontStyleEncabezado));
            _PdfPCell.Border = 0;
            _PdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            _PdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _PdfPCell.BackgroundColor = COLORDEREPORTE;
            ...
            _PdfPCell = new PdfPCell(new Phrase("Moneda Costo", _fontStyleEncabezado));
            _PdfPCell.Border = 0;
            _PdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            _PdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _PdfPCell.BackgroundColor = COLORDEREPORTE;
            ...
            _PdfPCell = new PdfPCell(new Phrase("Monto Rentbilidad", _fontStyleEncabezado));
            _PdfPCell.Border = 0;
            _PdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            _PdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _PdfPCell.BackgroundColor = COLORDEREPORTE;
            ...
            _PdfPCell = new PdfPCell(new Phrase("Monto Comisión", _fontStyleEncabezado));
            _PdfPCell.Border = 0;
            _PdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            _PdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _PdfPCell.BackgroundColor = COLORDEREPORTE;
            ...
            _PdfPCell = new PdfPCell(new Phrase("No. Pedido", _fontStyleEncabezado));
            _PdfPCell.Border = 0;
            _PdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            _PdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _PdfPCell.BackgroundColor = COLORDEREPORTE;
        ...
        private void ReportBody()
        {
            ...
            //  
            List<VComisionVendedor> cierrecom = new List<VComisionVendedor>();
            cierrecom = GetCierrecom(idmes, anio);

            foreach (VComisionVendedor c in cierrecom)
            {
                ...
                float[] anchoColumnasCierreV = { 20f, 20f, 40f, 40f, 20f, 20f, 40f, 40f, 40f, 20f, 20f, 20f, 50f, 20f, 20f, 50f, 50f, 20f, 20f, 30f };
                ...
                Font _fontStylecliente = new Font(Font.FontFamily.HELVETICA, 5, Font.BOLD);  // aqui podremos cambiar la fuente de lcientes y su tamanño

            
                PdfPCell _PdfPCell4 = new PdfPCell(new Phrase(c.FechaFac.ToString(), _fontStylecliente));
                _PdfPCell4.Border = 0;
                ...
                _PdfPCell = new PdfPCell(new Phrase(c.FechaPed.ToString(), _fontStylecliente));
                _PdfPCell.Border = 0;
                ...
                _PdfPCell = new PdfPCell(new Phrase(c.Cliente, _fontStylecliente));
                _PdfPCell.Border = 0;
                tablaCierreV.AddCell(_PdfPCell);

                _PdfPCell = new PdfPCell(new Phrase(c.Serie, _fontStylecliente));
                _PdfPCell.Border = 0;
                tablaCierreV.AddCell(_PdfPCell);

                _PdfPCell = new PdfPCell(new Phrase(c.NoFactura.ToString(), _fontStylecliente));
                _PdfPCell.Border = 0;
                tablaCierreV.AddCell(_PdfPCell);

                _PdfPCell = new PdfPCell(new Phrase(c.Subtotal.ToString(), _fontStylecliente));
                _PdfPCell.Border = 0;
                tablaCierreV.AddCell(_PdfPCell);

                _PdfPCell = new PdfPCell(new Phrase(c.Rentabilidad.ToString(), _fontStylecliente));
                _PdfPCell.Border = 0;
                tablaCierreV.AddCell(_PdfPCell);

                _PdfPCell = new PdfPCell(new Phrase(c.Penalizaciones.ToString(), _fontStylecliente));
                _PdfPCell.Border = 0;
                tablaCierreV.AddCell(_PdfPCell);
                ...
                _PdfPCell = new PdfPCell(new Phrase(c.Tipo.ToString(), _fontStylecliente));
                _PdfPCell.Border = 0;
                tablaCierreV.AddCell(_PdfPCell);

                if (c.Pagada == true)
                {
                _PdfPCell = new PdfPCell(new Phrase("SI", _fontStylecliente));
                _PdfPCell.Border = 0;
                tablaCierreV.AddCell(_PdfPCell);
                }
                else
                {
                    _PdfPCell = new PdfPCell(new Phrase("NO", _fontStylecliente));
                    _PdfPCell.Border = 0;
                    tablaCierreV.AddCell(_PdfPCell);
                }

                _PdfPCell = new PdfPCell(new Phrase(c.Costo.ToString(), _fontStylecliente));
                _PdfPCell.Border = 0;
                tablaCierreV.AddCell(_PdfPCell);

                _PdfPCell = new PdfPCell(new Phrase(c.MonedaFactura.ToString(), _fontStylecliente));
                _PdfPCell.Border = 0;
                tablaCierreV.AddCell(_PdfPCell);

                _PdfPCell = new PdfPCell(new Phrase(c.MonedaCosto.ToString(), _fontStylecliente));
                _PdfPCell.Border = 0;
                tablaCierreV.AddCell(_PdfPCell);

                _PdfPCell = new PdfPCell(new Phrase(c.MontoRentabilidad.ToString(), _fontStylecliente));
                _PdfPCell.Border = 0;
                tablaCierreV.AddCell(_PdfPCell);


                _PdfPCell = new PdfPCell(new Phrase(c.MontoComision.ToString(), _fontStylecliente));
                _PdfPCell.Border = 0;
                tablaCierreV.AddCell(_PdfPCell);

                _PdfPCell = new PdfPCell(new Phrase(c.NoPedido.ToString(), _fontStylecliente));
                _PdfPCell.Border = 0;
                tablaCierreV.AddCell(_PdfPCell);

                _PdfPCell = new PdfPCell(new Phrase(c.aniocom.ToString(), _fontStylecliente));
                _PdfPCell.Border = 0;
                tablaCierreV.AddCell(_PdfPCell);

                //_fontStyle = FontFactory.GetFont("Tahoma", 9f, 1);
                _PdfPCell = new PdfPCell(new Phrase(c.mescom.ToString(), _fontStylecliente));
                _PdfPCell.Border = 0;
                tablaCierreV.AddCell(_PdfPCell);
