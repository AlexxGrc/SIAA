...
namespace SIAAPI.Reportes
{
    public class Rprt_Comisiones
    {
        ...
        public List<CierreComisiones> ListaDatosBD_CierreComisiones = new List<CierreComisiones>();
        //public List<c_Meses> meses = new List<c_Meses>();
        ...
        {
            titulo = "REPORTE DEL CIERRE DE COMISIONES";
            //↓--Logo desde BD
            ...
            float[] anchoColEncCont = { 33f, 33f, 33f, 33f, 33f, 33f, 33f, 33f, 33f, 33f, 33f, 33f, 33f, 33f, 33f, 33f, 33f, 33f };//ancho de las columas del encabezado de tabla de contenido
            ...
            celdaPdf = new PdfPCell(new Phrase("Mes", fontEncCont));
            celdaPdf.Border = 0;
            ...
            celdaPdf = new PdfPCell(new Phrase("Año", fontEncCont));
            celdaPdf.Border = 0;
            celdaPdf.HorizontalAlignment = Element.ALIGN_LEFT;
            celdaPdf.VerticalAlignment = Element.ALIGN_MIDDLE;
            celdaPdf.BackgroundColor = COLORDEREPORTE;
            ...
            celdaPdf = new PdfPCell(new Phrase("Vendedor", fontEncCont));
            celdaPdf.Border = 0;
            celdaPdf.HorizontalAlignment = Element.ALIGN_LEFT;
            celdaPdf.VerticalAlignment = Element.ALIGN_MIDDLE;
            celdaPdf.BackgroundColor = COLORDEREPORTE;
            ...
            celdaPdf = new PdfPCell(new Phrase("Pedidos totales", fontEncCont));
            celdaPdf.Border = 0;
            celdaPdf.HorizontalAlignment = Element.ALIGN_LEFT;
            celdaPdf.VerticalAlignment = Element.ALIGN_MIDDLE;
            celdaPdf.BackgroundColor = COLORDEREPORTE;
            ...
            celdaPdf = new PdfPCell(new Phrase("Ventas MXN", fontEncCont));
            celdaPdf.Border = 0;
            celdaPdf.HorizontalAlignment = Element.ALIGN_LEFT;
            celdaPdf.VerticalAlignment = Element.ALIGN_MIDDLE;
            celdaPdf.BackgroundColor = COLORDEREPORTE;
            ...
            celdaPdf = new PdfPCell(new Phrase("Ventas USD", fontEncCont));
            celdaPdf.Border = 0;
            celdaPdf.HorizontalAlignment = Element.ALIGN_LEFT;
            celdaPdf.VerticalAlignment = Element.ALIGN_MIDDLE;
            celdaPdf.BackgroundColor = COLORDEREPORTE;
            ...
            celdaPdf = new PdfPCell(new Phrase("Cuota establecida", fontEncCont));
            celdaPdf.Border = 0;
            celdaPdf.HorizontalAlignment = Element.ALIGN_LEFT;
            celdaPdf.VerticalAlignment = Element.ALIGN_MIDDLE;
            celdaPdf.BackgroundColor = COLORDEREPORTE;
            ...
            celdaPdf = new PdfPCell(new Phrase("Cuota alcanzada", fontEncCont));
            celdaPdf.Border = 0;
            celdaPdf.HorizontalAlignment = Element.ALIGN_LEFT;
            celdaPdf.VerticalAlignment = Element.ALIGN_MIDDLE;
            celdaPdf.BackgroundColor = COLORDEREPORTE;
            ...
            celdaPdf = new PdfPCell(new Phrase("Moneda de cuota", fontEncCont));
            celdaPdf.Border = 0;
            celdaPdf.HorizontalAlignment = Element.ALIGN_LEFT;
            celdaPdf.VerticalAlignment = Element.ALIGN_MIDDLE;
            celdaPdf.BackgroundColor = COLORDEREPORTE;
            ...
            celdaPdf = new PdfPCell(new Phrase("Comisión", fontEncCont));
            celdaPdf.Border = 0;
            celdaPdf.HorizontalAlignment = Element.ALIGN_LEFT;
            celdaPdf.VerticalAlignment = Element.ALIGN_MIDDLE;
            celdaPdf.BackgroundColor = COLORDEREPORTE;
        ...
        {
            foreach (CierreComisiones BDCierreComisiones in ListaDatosBD_CierreComisiones)
            {
                CierreVentasContext db = new CierreVentasContext();
                ClsDatoString vendedores = db.Database.SqlQuery<ClsDatoString>("select Nombre as Dato from Vendedor where IDVendedor = " + BDCierreComisiones.IDVendedor).ToList()[0];
                ClsDatoString clientes = db.Database.SqlQuery<ClsDatoString>("select Nombre as Dato from Clientes where IDCLiente = " + BDCierreComisiones.IDCliente).ToList()[0];

                //↓--Creacion de tabla para contenido de tabla
                float[] anchoColCont = { 33f, 33f, 33f, 33f, 33f, 33f, 33f, 33f, 33f, 33f, 33f, 33f, 33f, 33f, 33f, 33f, 33f, 33f };
                ...
                celdaPdf = new PdfPCell(new Phrase(BDCierreComisiones.FechaFac.ToString("dd/MM/yyyy"), fontCont));
                celdaPdf.Border = 0;
                celdaPdf.HorizontalAlignment = Element.ALIGN_LEFT;
                celdaPdf.VerticalAlignment = Element.ALIGN_MIDDLE;
                ...
                celdaPdf = new PdfPCell(new Phrase(BDCierreComisiones.FechaPed.ToString("dd/MM/yyyy"), fontCont));
                celdaPdf.Border = 0;
                celdaPdf.HorizontalAlignment = Element.ALIGN_LEFT;
                celdaPdf.VerticalAlignment = Element.ALIGN_MIDDLE;
                celdaPdf.BackgroundColor = BaseColor.WHITE;
                ...
                celdaPdf = new PdfPCell(new Phrase(vendedores.Dato, fontCont));
                celdaPdf.Border = 0;
                celdaPdf.HorizontalAlignment = Element.ALIGN_LEFT;
                celdaPdf.VerticalAlignment = Element.ALIGN_MIDDLE;
                celdaPdf.BackgroundColor = BaseColor.WHITE;
                ...
                celdaPdf = new PdfPCell(new Phrase(clientes.Dato, fontCont));
                celdaPdf.Border = 0;
                celdaPdf.HorizontalAlignment = Element.ALIGN_LEFT;
                celdaPdf.VerticalAlignment = Element.ALIGN_MIDDLE;
                celdaPdf.BackgroundColor = BaseColor.WHITE;
                ...
                celdaPdf = new PdfPCell(new Phrase(BDCierreComisiones.Serie.ToString(), fontCont));
                celdaPdf.Border = 0;
                celdaPdf.HorizontalAlignment = Element.ALIGN_LEFT;
                celdaPdf.VerticalAlignment = Element.ALIGN_MIDDLE;
                celdaPdf.BackgroundColor = BaseColor.WHITE;
                ...
                celdaPdf = new PdfPCell(new Phrase(BDCierreComisiones.NoFactura.ToString(), fontCont));
                celdaPdf.Border = 0;
                celdaPdf.HorizontalAlignment = Element.ALIGN_LEFT;
                celdaPdf.VerticalAlignment = Element.ALIGN_MIDDLE;
                celdaPdf.BackgroundColor = BaseColor.WHITE;
                ...
                celdaPdf = new PdfPCell(new Phrase(BDCierreComisiones.Subtotal.ToString("C"), fontCont));
                celdaPdf.Border = 0;
                celdaPdf.HorizontalAlignment = Element.ALIGN_LEFT;
                celdaPdf.VerticalAlignment = Element.ALIGN_MIDDLE;
                celdaPdf.BackgroundColor = BaseColor.WHITE;
                ...
                celdaPdf = new PdfPCell(new Phrase(BDCierreComisiones.Rentabilidad.ToString("P"), fontCont));
                celdaPdf.Border = 0;
                celdaPdf.HorizontalAlignment = Element.ALIGN_LEFT;
                celdaPdf.VerticalAlignment = Element.ALIGN_MIDDLE;
                celdaPdf.BackgroundColor = BaseColor.WHITE;
                ...
                celdaPdf = new PdfPCell(new Phrase(BDCierreComisiones.Penalizaciones.ToString("C"), fontCont));
                celdaPdf.Border = 0;
                celdaPdf.HorizontalAlignment = Element.ALIGN_LEFT;
                celdaPdf.VerticalAlignment = Element.ALIGN_MIDDLE;
                celdaPdf.BackgroundColor = BaseColor.WHITE;
                ...
                celdaPdf = new PdfPCell(new Phrase(BDCierreComisiones.Comision.ToString(), fontCont));
                celdaPdf.Border = 0;
                celdaPdf.HorizontalAlignment = Element.ALIGN_LEFT;
                celdaPdf.VerticalAlignment = Element.ALIGN_MIDDLE;
                celdaPdf.BackgroundColor = BaseColor.WHITE;
                ...
                celdaPdf = new PdfPCell(new Phrase(BDCierreComisiones.Tipo.ToString(), fontCont));
                celdaPdf.Border = 0;
                celdaPdf.HorizontalAlignment = Element.ALIGN_LEFT;
                celdaPdf.VerticalAlignment = Element.ALIGN_MIDDLE;
                celdaPdf.BackgroundColor = BaseColor.WHITE;
                ...
                celdaPdf = new PdfPCell(new Phrase(BDCierreComisiones.Pagada.ToString(), fontCont));
                celdaPdf.Border = 0;
                celdaPdf.HorizontalAlignment = Element.ALIGN_LEFT;
                celdaPdf.VerticalAlignment = Element.ALIGN_MIDDLE;
                celdaPdf.BackgroundColor = BaseColor.WHITE;
                ...
                celdaPdf = new PdfPCell(new Phrase(BDCierreComisiones.Costo.ToString("C"), fontCont));
                celdaPdf.Border = 0;
                celdaPdf.HorizontalAlignment = Element.ALIGN_LEFT;
                celdaPdf.VerticalAlignment = Element.ALIGN_MIDDLE;
                celdaPdf.BackgroundColor = BaseColor.WHITE;
                ...
                celdaPdf = new PdfPCell(new Phrase(BDCierreComisiones.MonedaFactura.ToString(), fontCont));
                celdaPdf.Border = 0;
                celdaPdf.HorizontalAlignment = Element.ALIGN_LEFT;
                celdaPdf.VerticalAlignment = Element.ALIGN_MIDDLE;
                celdaPdf.BackgroundColor = BaseColor.WHITE;
                ...
                celdaPdf = new PdfPCell(new Phrase(BDCierreComisiones.MonedaCosto.ToString(), fontCont));
                celdaPdf.Border = 0;
                celdaPdf.HorizontalAlignment = Element.ALIGN_LEFT;
                celdaPdf.VerticalAlignment = Element.ALIGN_MIDDLE;
                celdaPdf.BackgroundColor = BaseColor.WHITE;
                ...
                celdaPdf = new PdfPCell(new Phrase(BDCierreComisiones.MontoRentabilidad.ToString("C"), fontCont));
                celdaPdf.Border = 0;
                celdaPdf.HorizontalAlignment = Element.ALIGN_LEFT;
                celdaPdf.VerticalAlignment = Element.ALIGN_MIDDLE;
                celdaPdf.BackgroundColor = BaseColor.WHITE;
                ...
                celdaPdf = new PdfPCell(new Phrase(BDCierreComisiones.MontoComision.ToString("C"), fontCont));
                celdaPdf.Border = 0;
                celdaPdf.HorizontalAlignment = Element.ALIGN_LEFT;
                celdaPdf.VerticalAlignment = Element.ALIGN_MIDDLE;
                celdaPdf.BackgroundColor = BaseColor.WHITE;
                ...
                celdaPdf = new PdfPCell(new Phrase(BDCierreComisiones.NoPedido.ToString(), fontCont));
                celdaPdf.Border = 0;
                celdaPdf.HorizontalAlignment = Element.ALIGN_LEFT;
                celdaPdf.VerticalAlignment = Element.ALIGN_MIDDLE;
                celdaPdf.BackgroundColor = BaseColor.WHITE;
