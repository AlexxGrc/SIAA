...
namespace SIAAPI.Reportes
{
    public class ReporteUsoCFDI
    {
        ...
        #endregion
        public c_UsoCFDIContext db = new c_UsoCFDIContext();
        public List<c_UsoCFDI> usoCFDI = new List<c_UsoCFDI>();
...

        {
            ...
            HttpContext.Current.Response.AddHeader("content-disposition", "attachment; filename=\"ReporteUsoCFDI.pdf" + "\"");
        ...
        private void ReportHeader()
        {
            ...
            Font _fontStyleEncabezado = FontFactory.GetFont("Tahoma", 13f, COLORDEFUENTEREPORTE);
                ...
                _PdfPCell = new PdfPCell(new Phrase("Clave CFDI", _fontStyleEncabezado));
                _PdfPCell.Border = 0;
        ...
        private void ReportBody()
        {
            ...
            //  
                ...
                foreach (c_UsoCFDI b in usoCFDI)
                {
                    ...
                    float[] anchoColumnasusoCFDI= { 100f, 500f };

                    // 50 para id 3000 para el nombre 100 para el telefono y 150 para el vendedor

                    PdfPTable tablatipoCon = new PdfPTable(anchoColumnasusoCFDI);
                //tablaProductosPrincipal.DefaultCell.Border = Rectangle.NO_BORDER;
                tablatipoCon.SetTotalWidth(anchoColumnasusoCFDI);
                ...
                tablatipoCon.LockedWidth = true;
                    ...
                    PdfPCell _PdfPCell1 = new PdfPCell(new Phrase(b.ClaveCFDI, _fontStylecliente));
                    _PdfPCell1.Border = 0;
