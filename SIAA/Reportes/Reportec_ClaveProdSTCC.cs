...
namespace SIAAPI.Reportes
{
    ...
    public class Reportec_ClaveProdSTCC
    {
        #region Declaration
        ...
        #endregion
        public c_ClaveProdSTCCContext db = new c_ClaveProdSTCCContext();
        public List<c_ClaveProdSTCC> ClavePSTCC = new List<c_ClaveProdSTCC>();
...

        {
            ...
            HttpContext.Current.Response.AddHeader("content-disposition", "attachment; filename=\"ReporteClaveProdSTCC.pdf" + "\"");
        ...
        private void ReportHeader()
        {
            ...
            paragraph.Add("Productos y Servicios STCC");
        ...
        private void ReportBody()
        {
            ...
            foreach (c_ClaveProdSTCC b in ClavePSTCC)
            {
