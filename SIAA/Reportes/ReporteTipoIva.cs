...
{
    public class ReporteTipoIva
    {
        public c_TipoIVAContext tic = new c_TipoIVAContext();
        public List<c_TipoIVA> ti = new List<c_TipoIVA>();
...

        {
            ...
            HttpContext.Current.Response.AddHeader("content-disposition", "attachment; filename=\"ReporteTipoIva.pdf" + "\"");
        ...
        private void ReportHeader()
        {
            ...
            p1.Leading = 20;
            p1.Add(new Phrase("Catalogo Tipo Iva", new Font(Font.FontFamily.HELVETICA, 20, Font.BOLD)));
            p1.SpacingAfter = 40;
            _documento.Add(p1);
            ...
            _PdfPCell = new PdfPCell(new Phrase("Tasa", _fontStyleEncabezado));
            _PdfPCell.Border = 0;
        ...
        private void ReportBody()
        {
            ...
            foreach (c_TipoIVA b in ti)
            {
                ...
                float[] anchoColumnasTipoIva = { 300f, 300f };
                ...
                PdfPCell _PdfPCell1 = new PdfPCell(new Phrase(b.Tasa.ToString(), _fontStylecliente));
                _PdfPCell1.Border = 0;
