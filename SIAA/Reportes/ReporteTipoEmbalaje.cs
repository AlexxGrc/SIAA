...
{
    public class ReporteTipoEmbalaje
    {
        ...
        #endregion
        public c_TipoEmbalajeContext db = new c_TipoEmbalajeContext();
        public List<c_TipoEmbalaje> Embalaje = new List<c_TipoEmbalaje>();
        ...
        private void ReportHeader()
        {
            ...
            //_fontStyle = FontFactory.GetFont("Tahoma", 8f, COLORDEFUENTEREPORTE);
            _PdfPCell = new PdfPCell(new Phrase("Clave De Asignación ", _fontStyleEncabezado));
            _PdfPCell.Border = 0;
            _PdfPCell.HorizontalAlignment = Element.ALIGN_LEFT;
            _PdfPCell.VerticalAlignment = Element.ALIGN_MIDDLE;
            _PdfPCell.BackgroundColor = COLORDEREPORTE;
        ...
        private void ReportBody()
        {
            ...
            foreach (c_TipoEmbalaje b in Embalaje)
            {
                ...
                PdfPCell _PdfPCell1 = new PdfPCell(new Phrase(b.IDTEmbalaje.ToString(), _fontStylecliente));
                _PdfPCell1.Border = 0;
                ...
                PdfPCell _PdfPCell2 = new PdfPCell(new Phrase(b.ClaveDeAsignacion, _fontStylecliente));
                _PdfPCell2.Border = 0;
