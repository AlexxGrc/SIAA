...
{
    public class ReporteporFPagoProv
    {
        #region Declaration
        ...
        public byte[] PrepareReport(DateTime _fechaini, DateTime _fechafin, string _pago, string _esta, string _nota)
        {
            ...
            HttpContext.Current.Response.AddHeader("content-disposition", "attachment; filename=\"ReporteFechaPagoProveedor.pdf" + "\"");
        ...
        public List<ReportefenoProv> GetFacturas()
        {
            ...
            try
            {
                if (status == "T")
                {
                    ...
                    cadena = cadena + " where FechaPago>='" + fechaini.Year + "/" + fechaini.Month + "/" + fechaini.Day + " 00:00:01' and FechaPago <='" + fechafin.Year + "/" + fechafin.Month + "/" + fechafin.Day + " 23:59:59' and ClaveFormaPago=" + idPago;
                ...
                {
                    string cadena = "select ID,FechaPago, SerieP, FolioP,  RFC,Empresa, ClaveFormaPago, Descripcion as FormaPago, ClaveDivisa, NoOperacion, Monto, RFCBancoEmisor, NombreBancoEmisor, CuentaEmisor, RFCBancoReceptor,NombreBancoReceptor, CuentaReceptor, IDTipoCadenaPago,Estado, UUID from VPagoFacturaProvT";
                    cadena = cadena + " where FechaPago>='" + fechaini.Year + "/" + fechaini.Month + "/" + fechaini.Day + " 00:00:01' and FechaPago <='" + fechafin.Year + "/" + fechafin.Month + "/" + fechafin.Day + " 23:59:59' and ClaveFormaPago=" + idPago + "and Estado=1";
                    facturas = db.Database.SqlQuery<ReportefenoProv>(cadena).ToList();
                }
                if (status == "C")
                {
                    string cadena = "select ID,FechaPago, SerieP, FolioP,  RFC,Empresa, ClaveFormaPago, Descripcion as FormaPago, ClaveDivisa, NoOperacion, Monto, RFCBancoEmisor, NombreBancoEmisor, CuentaEmisor, RFCBancoReceptor,NombreBancoReceptor, CuentaReceptor, IDTipoCadenaPago,Estado, UUID from VPagoFacturaProvT";
                    cadena = cadena + " where FechaPago>='" + fechaini.Year + "/" + fechaini.Month + "/" + fechaini.Day + " 00:00:01' and FechaPago <='" + fechafin.Year + "/" + fechafin.Month + "/" + fechafin.Day + " 23:59:59' and ClaveFormaPago=" + idPago + "and Estado=0";
                    facturas = db.Database.SqlQuery<ReportefenoProv>(cadena).ToList();
                }
            }
        ...
        private void ReportHeader()
        {
            ...
            _PdfPCell = new PdfPCell(new Phrase("Reporte por Forma de Pago Proveedores", _fontStyle));
    ...
    public class ITextEventsRepLFacsProv : PdfPageEventHelper
    {
    ...
    public class fechasReporteFacsProv
    {
    ...
    public class ReporteFacturastProv
    {
        [Key]
