...
{
    public class Reportec_TipoPermiso
    {
        #region Declaration
        ...
        #endregion
        public c_TipoPermisoContext db = new c_TipoPermisoContext();
        public List<c_TipoPermiso> Tpermiso = new List<c_TipoPermiso>();
        ...
        public byte[] PrepareReport()
        {
            ...
            HttpContext.Current.Response.AddHeader("content-disposition", "attachment; filename=\"ReporteTipoPermiso.pdf" + "\"");
        ...
        private void ReportHeader()
        {
            ...
            paragraph.Add("Tipo de Permisos ");
            ...
            float[] anchoColumnasencart = { 50f,300f,50f, 100f,100f };
        ...
        private void ReportBody()
        {
            ...
            foreach (c_TipoPermiso b in Tpermiso)
            {
                ...
                float[] anchoColumnasBancos = { 50f, 300f, 50f, 100f, 100f };
                ...
                _fontStyle = FontFactory.GetFont("Tahoma", 10f, 1);
                _PdfPCell = new PdfPCell(new Phrase(b.ClaveT.ToString(), _fontStyle));
                _PdfPCell.Border = 0;
                tablaBancos.AddCell(_PdfPCell);
