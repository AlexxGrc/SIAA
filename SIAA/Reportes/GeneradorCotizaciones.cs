...
namespace SIAAPI.Reportes
{
    ...
    public class DocumentoCO
    {
        ...
        public string DireccionCliente = string.Empty;
        ...
        public List<ProductoCO> productos = new List<ProductoCO>();
        public List<ImpuestoCO> impuestos = new List<ImpuestoCO>();
        public List<RetencionCO> retenciones = new List<RetencionCO>();
    ...
    public class CreaCOPDF
    {
        ...
        public DocumentoCO _templatePDF; //Objeto que contendra la información del documento pdf
        XmlDocument xDoc; // Objeto para abrir el archivo xml

        public string nombreDocumento = string.Empty;
        public CreaCOPDF(System.Drawing.Image logo, DocumentoCO Coti)
        {
            ...
            nombreDocumento = HttpContext.Current.Server.MapPath("~/Documentostemporales/COTIZACIÓN" + Coti + ".pdf"); ;
            _documento = new Document(PageSize.LETTER);
            try
            {
                if (File.Exists(nombreDocumento))
                {
                    nombreDocumento = HttpContext.Current.Server.MapPath("~/Documentostemporales/COTIZACIÓN" + Coti + DateTime.Now.Day + DateTime.Now.Day + DateTime.Now.Year + DateTime.Now.Hour + DateTime.Now.Minute + DateTime.Now.Second + ".pdf");
                }
            }
            catch (Exception ERR)
            {
        ...
        private void Agregarpie()
        {
            ...
            tablafirmas.AddCell(new Phrase("\nAtentamente", new Font(Font.FontFamily.HELVETICA, 7, Font.BOLD)));
            ...
            codigoQR.Append("http://" + SIAAPI.Properties.Settings.Default.Nombredelaaplicacion + "/EncCotizacion/Details/" + _templatePDF.folio);
            ...
            tablafirmas.AddCell(new Phrase("__________________________________\n" + _templatePDF.vendedor, new Font(Font.FontFamily.HELVETICA, 6, Font.BOLD)));
        ...
        private void AgregaPropiedadesDocumento()
        {
            ...
            _documento.AddKeywords("Contización");
            _documento.AddSubject("Contización");
            _documento.AddTitle("COTIZACIÓN");
        ...
        private void AgregarDatosReceptor()
        {
            ...
            PdfPCell celda1 = new PdfPCell(new Phrase(_templatePDF.Cliente + "\n DIRECCIÓN: " + _templatePDF.DireccionCliente, new Font(Font.FontFamily.HELVETICA, 8)));
        ...
        private void AgregarDatosProductos()
        {
            ...
            tablaProductosTitulos.CompleteRow();
            ...
            foreach (LineadeproductosCO p in result2)
            {
        ...
        private void AgregarTotales()
        {
            ...
            foreach (ImpuestoCO i in _templatePDF.impuestos)
            {
            ...
            foreach (RetencionCO i in _templatePDF.retenciones)
            {
    ...
    public class LineadeproductosCO
    {

        public LineadeproductosCO() { }
    ...
    public class ITextEventsCO : PdfPageEventHelper
    {
        ...
        public override void OnEndPage(iTextSharp.text.pdf.PdfWriter writer, iTextSharp.text.Document document)
        {
            ...
            tabla.AddCell(new Phrase("Este documento es una Cotización ", new Font(Font.FontFamily.HELVETICA, 8)));
