...
namespace SIAAPI.clasescfdi
{
    public class PDFPagoP
    {
       ...
       //Objeto que contendra la información del documento pdf
        ...
        public PDFPagoP(string rutaXML, System.Drawing.Image logo, int folio,string Telefono = "")
        {

            documento = new ClsXmlPagos(rutaXML);
            nombreDocumento = HttpContext.Current.Server.MapPath("~/Documentostemporales/ComplementopagoP"+ folio + ".pdf");
