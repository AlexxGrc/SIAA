 ...
 public ActionResult EnRevision(int IDOrden, int? page, int? PageSize)
    ...
    return Rev;
        ...
        public JsonResult getSuaje(int IDSuaje)
        {
            ...
            try
            {
                suajec.Eje = decimal.Parse(formula.getvalor(SIAAPI.Properties.Settings.Default.AtributoEje, cara.Presentacion).ToString());
            }
            catch (Exception err)
            {
                string mensajederror = err.Message;
            ...
            try
            {
                suajec.Avance = decimal.Parse(formula.getvalor(SIAAPI.Properties.Settings.Default.AtributoAvance, cara.Presentacion).ToString());
            }
            catch (Exception err)
            {
                string mensajederror = err.Message;
            ...
            try
            {
                suajec.Gapeje = decimal.Parse(formula.getvalor(SIAAPI.Properties.Settings.Default.AtributoGapje, cara.Presentacion).ToString());
            }
            catch (Exception err)
            {
                string mensajederror = err.Message;
            ...
            try
            {
                suajec.Gapavance = decimal.Parse(formula.getvalor(SIAAPI.Properties.Settings.Default.AtributoGapAvance, cara.Presentacion).ToString());
            }
            catch (Exception err)
            {
                string mensajederror = err.Message;
            ...
            try
            {
                suajec.AnchoCinta = int.Parse(formula.getvalor(SIAAPI.Properties.Settings.Default.AtributoAnchoCinta, cara.Presentacion).ToString());
            }
            catch (Exception err)
            {
                string mensajederror = err.Message;
            ...
            try
            {
                suajec.AnchoCintaimpresa = int.Parse(formula.getvalor(SIAAPI.Properties.Settings.Default.AtributoAnchoCintaImpresa, cara.Presentacion).ToString());
            }
            catch (Exception err)
            {
                string mensajederror = err.Message;
