...
namespace SIAAPI.Controllers.Produccion
{
    public class TrabajadorProcesoController : Controller
    {
        ...
        public ActionResult Reporte()
        {
            ...
            reporte.Load(Path.Combine(Server.MapPath("~/reportes/Crystal/Administracion"), "TRABAJADORESYPROCESOS.rpt"));
            ...
            try
            {
                ...
                return File(stream, "application/pdf", "Catálogo de Trabajadores y Procesos.pdf");
